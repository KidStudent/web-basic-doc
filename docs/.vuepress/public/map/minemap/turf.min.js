!(function (t, e) {
  ...
  function S(t, e, n) {
    if (null !== t)
      for (
        ...
        a = (h =
          !!(c = g ? t.features[_].geometry : d ? t.geometry : t) &&
  ...
  function A(t, e) {
    ...
    for (n = 0; n < d; n++) {
      for (
        a = f ? t.features[n].geometry : g ? t.geometry : t,
  ...
  function U(t) {
    ...
    if (
      (t.length
        ...
        : t.coordinates
        ? (e = t.coordinates)
        : t.geometry && t.geometry.coordinates && (e = t.geometry.coordinates),
      e)
    )
      return Y(e), e;
  ...
  function W(t, e, n) {
    ...
    for (var r = 0; r < t.features.length; r++) {
      ...
      if (!i.geometry || i.geometry.type !== e)
        throw new Error(
          'Invalid input to ' + n + ': must be a ' + e + ', given ' + i.geometry.type,
        );
    }
  }
  function J(t) {
  ...
  function Z() {
    throw new Error(
      'invariant.getGeomType has been deprecated in v5.0 in favor of invariant.getType',
    );
  }
  function K(t, e) {
  ...
  function Q(t, e, n) {
    ...
    var a = (function (t) {
            ...
            if (
              ...
              var s = (function (t, e, n) {
                  ...
                  a.push([n + f[0], e + f[1]]),
                    ...
                    et(l);
                  for (
                    var g = n + u[p], d = e + c[p], y = p;
                    g >= 0 && d >= 0 && d < s && (g != n || d != e) && void 0 !== (l = t[d][g]);
                        ...
                        (5 === p
                          ? l.flipped
                            ? -1 === c[y]
                              ? ((o = 'left'), (r = -1), (i = 0))
                              : ((o = 'right'), (r = 1), (i = 0))
                            : -1 === u[y] && ((o = 'bottom'), (r = 0), (i = -1))
                          : 10 === p &&
                            (l.flipped
                              ? -1 === u[y]
                                ? ((o = 'top'), (r = 0), (i = 1))
                                : ((o = 'bottom'), (r = 0), (i = -1))
                              : 1 === c[y] && ((o = 'left'), (r = -1), (i = 0)))),
                      (f = nt(l, o)),
                      a.push([g + f[0], d + f[1]]),
                      et(l),
                      (g += r),
              ...
              if ('mergeable' === s.info)
                for (
                  var u = s.path[s.path.length - 1][0], c = s.path[s.path.length - 1][1], h = n - 1;
                  h >= 0;
                  h--
                )
      ...
      (function (t, e) {
        for (
          var n = t.length - 1, r = t[0].length - 1, i = { rows: n, cols: r, cells: [] }, o = 0;
          o < n;
          ++o
        ) {
          i.cells[o] = [];
              ...
              if (0 !== a && 15 !== a) {
                ...
                (g = d = y = _ = 0.5),
                  1 === a
                    ...
                    : 14 === a
                    ? ((y = $(e, l, u)), (d = $(e, l, h)))
                    : console.log('MarchingSquaresJS-isoContours: Illegal cval detected: ' + a),
                  (i.cells[o][s] = { cval: a, flipped: p, top: g, right: _, bottom: d, left: y });
              }
            }
          }
        }
    ...
    for (
      ...
      if (r - n > 600) {
        var o = r - n + 1,
          ...
          c = 0.5 * Math.sqrt((a * u * (o - u)) / o) * (s - o / 2 < 0 ? -1 : 1);
        it(
          t,
          e,
          Math.max(n, Math.floor(e - (s * u) / o + c)),
          Math.min(r, Math.floor(e + ((o - s) * u) / o + c)),
          i,
        );
      }
      var h = t[e],
  ...
  function _t(t, e, n, r, i) {
    for (var o, s = [e, n]; s.length; )
      (n = s.pop()) - (e = s.pop()) <= r ||
        ((o = e + Math.ceil((n - e) / r / 2) * r), Yo(t, o, e, n, i), s.push(e, o, o, n));
  }
  function mt(t, e) {
    ...
    for (var h = e * e, l = n * n; s.length; ) {
      ...
      if (!(d < l)) {
        ...
        (u = (function (t, e, n, r, i, o, s) {
          ...
          return null;
        })(o, p.prev.p, f, g, p.next.next.p, y, c)) &&
          Math.min(Ct(u, f), Ct(u, g)) <= y &&
          (s.push(p),
          s.push(Nt(u, p)),
          o.remove(u),
          c.remove(p),
  ...
  function bt(t, e, n) {
    for (
      var r = Math.min(t[0], e[0]),
        ...
        o = Math.max(t[0], e[0]),
        s = Math.max(t[1], e[1]),
        a = n.search({ minX: r, minY: i, maxX: o, maxY: s }),
        u = 0;
      u < a.length;
      u++
    )
      if (
        (function (t, e, n, r) {
          return (
            t !== r &&
            e !== n &&
            os(t, e, n) > 0 != os(t, e, r) > 0 &&
            os(n, r, t) > 0 != os(n, r, e) > 0
          );
    ...
    0 === b
      ...
      : ((l = m * w - v * E),
        (c = v * w - x * E) < 0
          ...
          : c > I && ((c = I), (l = w + v), (N = x))),
      l < 0
        ? ((l = 0), -E < 0 ? (c = 0) : -E > m ? (c = I) : ((c = -E), (I = m)))
        : l > N && ((l = N), -E + v < 0 ? (c = 0) : -E + v > m ? (c = I) : ((c = -E + v), (I = m))),
      (u = 0 === c ? 0 : c / I);
    ...
    return c(
      (function (t) {
        ...
        var p,
          ...
          m = [
            new At(
              { x: y - 20 * d, y: _ - d, __sentinel: !0 },
              { x: y, y: _ + 20 * d, __sentinel: !0 },
              { x: y + 20 * d, y: _ - d, __sentinel: !0 },
            ),
          ],
          v = [],
        ...
        a = t.length;
        for (; a--; ) {
          for (x.length = 0, p = m.length; p--; )
            (f = t[a].x - m[p].x) > 0 && f * f > m[p].r
              ? (v.push(m[p]), m.splice(p, 1))
              : ((g = t[a].y - m[p].y),
                f * f + g * g > m[p].r ||
                  (x.push(m[p].a, m[p].b, m[p].b, m[p].c, m[p].c, m[p].a), m.splice(p, 1)));
          for (Ft(x), p = x.length; p; )
            (n = x[--p]),
              (e = x[--p]),
              (r = t[a]),
              (i = n.x - e.x),
              ...
              Math.abs(s) > 1e-12 && m.push(new At(e, n, r));
        }
          ...
          return (
            e
              ...
              : 3 === t.geometry.coordinates.length &&
                ((n = !0), (r.z = t.geometry.coordinates[2])),
            r
          );
        }),
      ).map(function (t) {
        ...
        return (
          n
            ? (e.push(t.a.z), r.push(t.b.z), i.push(t.c.z))
            : (s = { a: t.a.z, b: t.b.z, c: t.c.z }),
          o([[e, r, i, e]], s)
        );
      }),
    );
  ...
  function Ft(t) {
    ...
    t: for (; s; )
      for (n = t[--s], e = t[--s], r = s; r; )
        if (((o = t[--r]), (i = t[--r]), (e === i && n === o) || (e === o && n === i))) {
  ...
  function Bt(t) {
    ...
    return (
      ...
      (e.properties = kt(t.properties)),
      (e.geometry = zt(t.geometry)),
      e
    );
  }
  function kt(t) {
    ...
    return (
      ...
      'GeometryCollection' === t.type
        ? ((e.geometries = t.geometries.map(function (t) {
          ...
          e)
        : ((e.coordinates = jt(t.coordinates)), e)
    );
  }
  function jt(t) {
      ...
      }),
      {
        ...
        arcs: a.map(function (e) {
          ...
          if (
            ...
            for (var s, a, u = 1, c = i(r[0]); u < n; ++u)
              (s = i(r[u])) > c && ((a = r[0]), (r[0] = r[u]), (r[u] = a), (c = s));
          return r;
        }),
      }
    );
  ...
  function Wt(t) {
    ...
    var e =
      'GeometryCollection' === t.type
        ? { type: 'GeometryCollection', geometries: t.geometries.map(Wt) }
  ...
  function Zt(t, e) {
    var n,
      ...
      s = e[1];
    return (
      i < r && ((n = r), (r = i), (i = n)), s < o && ((n = o), (o = s), (s = n)), r === o && i === s
    );
  }
  function Kt(t, e) {
    if (((e = e || {}), !I(e))) throw new Error('options is invalid');
  ...
  function te(t, n) {
    ...
    return t.coordinates
      ...
      : e({ type: i, coordinates: o }, t.properties, t.bbox, t.id);
  }
  function ee(t) {
    var e = U(t);
    if (
  ...
  function ae(t, e, n) {
    return t.map(function (t) {
      ...
      for (
        ...
        i = oe(r, (e -= 0.01 * e), n).map(function (t) {
          return [t.x, t.y];
        });
    ...
    return r(
      [
        v(
          u +
            Math.atan2(
              Math.sin(h) * Math.sin(l) * Math.cos(c),
              Math.cos(l) - Math.sin(c) * Math.sin(p),
            ),
        ),
        v(p),
      ],
        ...
        (o = (function (t, e, n, r) {
          ...
          for (i = 0, o = e.length; i < o; i++)
            (s = e[i] * r),
              ...
              (u = xe(t, s, a, r, !1)) === u.next && (u.steiner = !0),
              c.push(
                (function (t) {
                  var e = t,
                    n = t;
          ...
          for (c.sort(be), i = 0; i < c.length; i++)
            !(function (t, e) {
              if (
                (e = (function (t, e) {
                  var n,
                  ...
                  for (r = n.next; r !== c; )
                    i >= r.x &&
                      r.x >= h &&
                      i !== r.x &&
                      Ne(o < l ? i : s, o, h, l, o < l ? s : i, o, r.x, r.y) &&
                      ((u = Math.abs(o - r.y) / (i - r.x)) < p || (u === p && r.x > n.x)) &&
                      Le(r, t) &&
                      ((n = r), (p = u)),
                      (r = r.next);
                  return n;
  ...
  function xe(t, e, n, r, i) {
    var o, s;
    if (i === Ae(t, e, n, r) > 0) for (o = e; o < n; o += r) s = Oe(o, t[o], t[o + 1], s);
    else for (o = n - r; o >= e; o -= r) s = Oe(o, t[o], t[o + 1], s);
  ...
  function Ee(t, e) {
    ...
    var n,
      r = t;
    do {
      if (((n = !1), r.steiner || (!Se(r, r.next) && 0 !== Ce(r.prev, r, r.next)))) r = r.next;
      else {
        ...
        if (
          ...
          o
            ? (function (t, e, n, r) {
                ...
                for (; f && f.z <= p; ) {
                  if (
                    f !== t.prev &&
                    f !== t.next &&
                    Ne(i.x, i.y, o.x, o.y, s.x, s.y, f.x, f.y) &&
                    Ce(f.prev, f, f.next) >= 0
                  )
                    return !1;
                  f = f.nextZ;
                }
            ...
            : (function (t) {
                ...
                var i = t.next.next;
                for (; i !== t.prev; ) {
                  if (Ne(e.x, e.y, n.x, n.y, r.x, r.y, i.x, i.y) && Ce(i.prev, i, i.next) >= 0)
                    return !1;
                  i = i.next;
                }
                return !0;
          ...
          e.push(a.i / n), e.push(t.i / n), e.push(u.i / n), Re(t), (t = u.next), (c = u.next);
        else if ((t = u) === c) {
          s
            ? 1 === s
              ? we(
  ...
  function Me(t, e, n, r) {
    return (
      !!((Se(t, e) && Se(n, r)) || (Se(t, r) && Se(n, e))) ||
      (Ce(t, e, n) > 0 != Ce(t, e, r) > 0 && Ce(n, r, t) > 0 != Ce(n, r, e) > 0)
    );
  }
  function Le(t, e) {
    return Ce(t.prev, t, t.next) < 0
      ? Ce(t, e, t.next) >= 0 && Ce(t, t.prev, e) >= 0
      : Ce(t, e, t.prev) < 0 || Ce(t, t.next, e) < 0;
  }
  function Pe(t, e) {
  ...
  function De(t) {
    var e = (function (t) {
        for (
          var e = t[0][0].length, n = { vertices: [], holes: [], dimensions: e }, r = 0, i = 0;
          i < t.length;
          i++
        ) {
  ...
  function Fe(t, e) {
    ...
    return (
      O(e, function (e, i) {
        var o = qt(t, e);
        o < r &&
          (((n = Gt(e)).properties.featureIndex = i), (n.properties.distanceToPoint = o), (r = o));
      }),
      n
    );
  }
  ...
  function Ke(t, e, n, r, i) {
    for (var o, s = [e, n]; s.length; )
      (n = s.pop()) - (e = s.pop()) <= r ||
        (qe(t, (o = e + Math.ceil((n - e) / r / 2) * r), e, n, i), s.push(e, o, o, n));
  }
  function Qe(t) {
    var e = ke(t);
    return (
      ...
      (e.toBBox = function (t) {
        var e;
        return (
          (e = t.bbox ? t.bbox : Array.isArray(t) && 4 === t.length ? t : tn(t)),
  ...
  function nn(t, n) {
    var r = {},
      i = [];
    if (
      ('LineString' === t.type && (t = e(t)),
      'LineString' === n.type && (n = e(n)),
      'Feature' === t.type &&
        'Feature' === n.type &&
        'LineString' === t.geometry.type &&
        'LineString' === n.geometry.type &&
        2 === t.geometry.coordinates.length &&
        2 === n.geometry.coordinates.length)
    ) {
      var o = rn(t, n);
  ...
  function on(t, e, n) {
    ...
    if ('LineString' !== i && 'MultiLineString' !== i)
      throw new Error('lines must be LineString or MultiLineString');
    var o = r([1 / 0, 1 / 0], { dist: 1 / 0 }),
      s = 0;
    return (
      F(t, function (t) {
        for (var i = U(t), u = 0; u < i.length - 1; u++) {
          ...
          var l = qt(c, h, n),
            ...
            d = pe(e, p, f - 90, n),
            y = nn(
              a([g.geometry.coordinates, d.geometry.coordinates]),
              a([c.geometry.coordinates, h.geometry.coordinates]),
            ),
            _ = null;
          y.features.length > 0 &&
            (((_ = y.features[0]).properties.dist = qt(e, _, n)),
            (_.properties.location = s + qt(c, _, n))),
            c.properties.dist < o.properties.dist &&
              (((o = c).properties.index = u), (o.properties.location = s)),
            h.properties.dist < o.properties.dist &&
              (((o = h).properties.index = u + 1), (o.properties.location = s + l)),
            _ && _.properties.dist < o.properties.dist && ((o = _).properties.index = u),
            (s += l);
        }
      }),
      o
  ...
  function ln(t, e, n) {
    ...
    if (!t) throw new Error('geojson is required');
    return (
      Array.isArray(t) && b(t[0])
        ? (t = 'mercator' === e ? pn(t) : fn(t))
        : (!0 !== r && (t = Gt(t)),
          S(t, function (t) {
    ...
    var e = Math.PI / 180,
      ...
      r = [
        6378137 *
          ...
          e,
        6378137 * Math.log(Math.tan(0.25 * Math.PI + 0.5 * t[1] * e)),
      ];
    return (
      r[0] > n && (r[0] = n),
      r[0] < -n && (r[0] = -n),
  ...
  function fn(t) {
    var e = 180 / Math.PI;
    return [(t[0] * e) / 6378137, (0.5 * Math.PI - 2 * Math.atan(Math.exp(-t[1] / 6378137))) * e];
  }
  function gn(t, n, i) {
    if (((i = i || {}), !I(i))) throw new Error('options is invalid');
    if (!t) throw new Error('pt is required');
    if (
      (Array.isArray(t) ? (t = r(t)) : 'Point' === t.type ? (t = e(t)) : H(t, 'Point', 'point'), !n)
    )
        ...
        var e = t.geometry.coordinates[0],
          ...
          a = (function (t, e, n, i) {
            ...
            return p > 90
              ...
              : (function (t, e, n, i) {
                  var o = 0;
                  (Math.abs(t[0]) >= 180 || Math.abs(e[0]) >= 180 || Math.abs(n[0]) >= 180) &&
                    (o = t[0] > 0 || e[0] > 0 || n[0] > 0 ? -180 : 180);
                  var s = r(n),
                    a = cn([t[0] + o, t[1]]),
                    u = cn([e[0] + o, e[1]]),
                    c = cn([n[0] + o, n[1]]),
  ...
  function yn(t) {
    for (
      ...
      var a,
        ...
        h = !1;
      if ('Point' === u.type)
        i.geometry.coordinates[0] === u.coordinates[0] &&
          i.geometry.coordinates[1] === u.coordinates[1] &&
          (o = !0);
      else if ('MultiPoint' === u.type) {
        var l = !1;
        for (a = 0; !l && a < u.coordinates.length; )
          i.geometry.coordinates[0] === u.coordinates[a][0] &&
            i.geometry.coordinates[1] === u.coordinates[a][1] &&
            ((o = !0), (l = !0)),
            a++;
      } else if ('LineString' === u.type)
        for (a = 0; !h && a < u.coordinates.length - 1; )
          _n(
        ...
        for (var p = 0; p < u.coordinates.length; ) {
          (h = !1), (a = 0);
          for (var f = u.coordinates[p]; !h && a < f.length - 1; )
            _n(
              i.geometry.coordinates[0],
              i.geometry.coordinates[1],
              f[a][0],
    ...
    for (s = 0; s < n.features.length; s++)
      g.features = g.features.concat(me(n.features[s]).features);
    return r(Fe(i, g).geometry.coordinates);
  }
  function _n(t, e, n, r, i, o) {
    return (
      Math.sqrt((i - n) * (i - n) + (o - r) * (o - r)) ===
      Math.sqrt((t - n) * (t - n) + (e - r) * (e - r)) +
        Math.sqrt((i - t) * (i - t) + (o - e) * (o - e))
    );
  }
  function mn(t) {
    return D(
    ...
    if (u > 2) {
      for (s = 0; s < u; s++)
        s === u - 2
          ...
          (e = t[r]),
          (n = t[i]),
          (a += (wn(t[o][0]) - wn(e[0])) * Math.sin(wn(n[1])));
      a = (a * Ss * Ss) / 2;
    }
    return a;
  }
      ...
      case 'LineString':
        switch (r) {
          case 'LineString':
            return (function (t, e) {
              for (var n = 0; n < t.coordinates.length; n++)
                if (!Nn(t.coordinates[n], e)) return !1;
              return !0;
            })(i, o);
          case 'Polygon':
            return (function (t, e) {
          ...
          case 'Polygon':
            return (function (t, e) {
              ...
              for (var r = 0; r < t.coordinates[0].length; r++)
                if (!Pt(t.coordinates[0][r], e)) return !1;
              return !0;
            })(i, o);
          default:
            throw new Error('feature2 ' + r + ' geometry not supported');
  ...
  function Ln(t, e, n) {
    ...
    for (
      var a = t[0],
        ...
        h = t[2],
        l = t[3],
        p = (e / qt([a, u], [h, u], n)) * (h - a),
        f = (e / qt([a, u], [a, l], n)) * (l - u),
        g = h - a,
        d = l - u,
        y = Math.floor(g / p),
        _ = (d - Math.floor(d / f) * f) / 2,
        m = a + (g - y * p) / 2;
      m <= h;
  ...
  function Pn(t, e) {
    ...
    var n = e.precision,
      ...
      i = e.mutate;
    if (
      ((n = void 0 === n || null === n || isNaN(n) ? 6 : n),
      (r = void 0 === r || null === r || isNaN(r) ? 3 : r),
      !t)
    )
  ...
  function Rn(t, e) {
    ...
    return (
      (t[1][0] - t[0][0]) * (t[2][1] - t[0][1]) - (t[1][1] - t[0][1]) * (t[2][0] - t[0][0]) >= 0 ==
      e
    );
  }
  function Tn(t, e) {
    ...
    return (
      F(e, function (e) {
        if (
          ...
          (n = Dn(t, e).features).forEach(function (t) {
  ...
  function Gn(t, e, n, r, i) {
    ...
    for (var l = u, p = u < c ? c : c + 360, f = l, g = [], d = 0; f < p; )
      g.push(pe(t, e, f, s).geometry.coordinates), (f = l + (360 * ++d) / o);
  ...
  function jn(t, e) {
    ...
    switch (K(t)) {
      ...
      case 'GeometryCollection':
        var o = [];
        return (
          (t.features ? t.features : t.geometries).forEach(function (t) {
            o.push(U(Xn(t, {}, r, i)));
          }),
          p(o, n)
        );
  ...
  function Yn(t, e, n) {
    ...
    for (n || (n = []), r = 1; r < u; r++) {
      for (i = t[r - 1], s = a = Hn((o = t[r]), e); ; ) {
        if (!(c | s)) {
          h.push(i),
            s !== a ? (h.push(o), r < u - 1 && (n.push(h), (h = []))) : r === u - 1 && h.push(o);
          break;
        }
        if (c & s) break;
  ...
  function Wn(t, e) {
    for (var n = [], r = 0; r < t.length; r++) {
      ...
      i.length > 0 &&
        ((i[0][0] === i[i.length - 1][0] && i[0][1] === i[i.length - 1][1]) || i.push(i[0]),
        i.length >= 4 && n.push(i));
    }
    return n;
  }
          ...
          if (!1 === e) {
            ...
            Zn(i, o)
              ...
              : (
                  0 === r
                    ? Nn(i[0], n) && Nn(i[1], n)
                    : on(n, i[0]).properties.dist <= r && on(n, i[1]).properties.dist <= r
                )
              ? ((e = !0), (s = s ? tr(s, t) : t))
              : (0 === r
                  ? Nn(o[0], t) && Nn(o[1], t)
                  : on(t, o[0]).properties.dist <= r && on(t, o[1]).properties.dist <= r) &&
                (s = s ? tr(s, n) : n);
          }
        }),
  ...
  function or(t) {
    ...
    for (var n, r, i = U(t), o = 0, s = 1; s < i.length; )
      (n = r || i[0]), (o += ((r = i[s])[0] - n[0]) * (r[1] + n[1])), s++;
    return o > 0;
  }
  function sr(t, e) {
  ...
  function hr(t, e, n, r) {
    ...
    zs.verbose &&
      console.log('MarchingSquaresJS-isoBands: computing isobands for [' + e + ':' + (e + n) + ']');
    var u,
      c = (function (t, e, n) {
        for (
          var r = t.length - 1,
            i = t[0].length - 1,
            o = { rows: r, cols: i, cells: [] },
            s = e + Math.abs(n),
            a = 0;
          a < r;
          ++a
          ...
          for (var u = 0; u < i; ++u) {
            ...
            if (!(isNaN(h) || isNaN(l) || isNaN(p) || isNaN(f))) {
              ...
              if (0 != c && 170 != c) {
                ...
                var N = [];
                1 === c
                  ? ((v = 1 - lr(e, p, f)), (I = 1 - lr(e, h, f)), N.push(Sa[c]))
                  : 169 === c
                  ? ((v = lr(s, f, p)), (I = lr(s, f, h)), N.push(Sa[c]))
                  : 4 === c
                  ? ((w = 1 - lr(e, l, p)), (x = lr(e, f, p)), N.push(Na[c]))
                  : 166 === c
                  ? ((w = lr(s, p, l)), (x = 1 - lr(s, p, f)), N.push(Na[c]))
                  : 16 === c
                  ? ((E = lr(e, p, l)), (m = lr(e, h, l)), N.push(Ia[c]))
                  : 154 === c
                  ? ((E = 1 - lr(s, l, p)), (m = 1 - lr(s, l, h)), N.push(Ia[c]))
                  : 64 === c
                  ? ((b = lr(e, f, h)), (_ = 1 - lr(e, l, h)), N.push(La[c]))
                  : 106 === c
                  ? ((b = 1 - lr(s, h, f)), (_ = lr(s, h, l)), N.push(La[c]))
                  : 168 === c
                  ? ((x = lr(s, f, p)),
                    (v = lr(e, f, p)),
                    (I = lr(e, f, h)),
                  ...
                  : 128 === c &&
                    ...
                    N.push(La[c])),
                  5 === c
                    ? ((w = 1 - lr(e, l, p)), (I = 1 - lr(e, h, f)), N.push(Na[c]))
                    : 165 === c
                    ? ((w = lr(s, p, l)), (I = lr(s, f, h)), N.push(Na[c]))
                    : 20 === c
                    ? ((x = lr(e, f, p)), (m = lr(e, h, l)), N.push(Ca[c]))
                    : 150 === c
                    ? ((x = 1 - lr(s, p, f)), (m = 1 - lr(s, l, h)), N.push(Ca[c]))
                    : 80 === c
                    ? ((E = lr(e, p, l)), (b = lr(e, f, h)), N.push(Ia[c]))
                    : 90 === c
                    ? ((E = 1 - lr(s, l, p)), (b = 1 - lr(s, h, f)), N.push(Ia[c]))
                    : 65 === c
                    ? ((v = 1 - lr(e, p, f)), (_ = 1 - lr(e, l, h)), N.push(Sa[c]))
                    : 105 === c
                    ? ((v = lr(s, f, p)), (_ = lr(s, h, l)), N.push(Sa[c]))
                    : 160 === c
                    ? ((E = lr(s, p, l)),
                      (w = lr(e, p, l)),
                      (I = lr(e, f, h)),
                    ...
                    ? ((x = lr(s, f, p)),
                      ...
                      N.push(Sa[c]))
                    : 101 === c
                    ? ((w = lr(s, p, l)), (_ = lr(s, h, l)), N.push(Na[c]))
                    : 69 === c
                    ? ((w = 1 - lr(e, l, p)), (_ = 1 - lr(e, l, h)), N.push(Na[c]))
                    : 149 === c
                    ? ((I = lr(s, f, h)), (m = 1 - lr(s, l, h)), N.push(Ma[c]))
                    : 21 === c
                    ? ((I = 1 - lr(e, h, f)), (m = lr(e, h, l)), N.push(Ma[c]))
                    : 86 === c
                    ? ((x = 1 - lr(s, p, f)), (b = 1 - lr(s, h, f)), N.push(Ca[c]))
                    : 84 === c
                    ? ((x = lr(e, f, p)), (b = lr(e, f, h)), N.push(Ca[c]))
                    : 89 === c
                    ? ((E = 1 - lr(s, l, p)), (v = lr(s, f, p)), N.push(Sa[c]))
                    : 81 === c
                    ? ((E = lr(e, p, l)), (v = 1 - lr(e, p, f)), N.push(Sa[c]))
                    : 96 === c
                    ? ((E = lr(s, p, l)),
                      (w = lr(e, p, l)),
                      (b = lr(e, f, h)),
                    ...
                    ? (4 === d
                      ...
                      N.push(La[c]))
                    : 85 === c &&
                      ((E = 1), (w = 0), (x = 1), (v = 0), (I = 0), (b = 1), (_ = 0), (m = 1)),
                  (_ < 0 ||
                    _ > 1 ||
                    m < 0 ||
                    m > 1 ||
    ...
    return (
        ...
        ? (zs.verbose &&
          ...
          (u = (function (t) {
            var e = [],
              n = 0;
            return (
              t.cells.forEach(function (t, r) {
                t.forEach(function (t, i) {
                  if (void 0 !== t) {
                    var o = Ra[t.cval](t);
                    'object' == typeof o && pr(o)
                      ? 'object' == typeof o[0] && pr(o[0])
                        ? 'object' == typeof o[0][0] && pr(o[0][0])
                ...
                if (void 0 !== t.cells[o][s] && t.cells[o][s].edges.length > 0) {
                    ...
                    u = (function (t) {
                      if (t.edges.length > 0) {
                        ...
                        switch (e) {
                          case 0:
                            return n & Xs
                              ? { p: [1, t.righttop], x: -1, y: 0, o: 1 }
                              : { p: [t.topleft, 1], x: 0, y: -1, o: 0 };
                          case 1:
                            return n & Us
                              ? { p: [t.topleft, 1], x: 0, y: -1, o: 0 }
                              : { p: [1, t.rightbottom], x: -1, y: 0, o: 0 };
                          case 2:
                            return n & Us
                              ? { p: [t.bottomright, 0], x: 0, y: 1, o: 1 }
                              : { p: [t.topleft, 1], x: 0, y: -1, o: 0 };
                          case 3:
                            return n & Ys
                              ? { p: [t.topleft, 1], x: 0, y: -1, o: 0 }
                              : { p: [t.bottomleft, 0], x: 0, y: 1, o: 0 };
                          case 4:
                            return n & Xs
                              ? { p: [1, t.righttop], x: -1, y: 0, o: 1 }
                              : { p: [t.topright, 1], x: 0, y: -1, o: 1 };
                          case 5:
                            return n & Us
                              ? { p: [t.topright, 1], x: 0, y: -1, o: 1 }
                              : { p: [1, t.rightbottom], x: -1, y: 0, o: 0 };
                          ...
                          case 10:
                            return n & Ys
                              ? { p: [0, t.leftbottom], x: 1, y: 0, o: 0 }
                              : { p: [1, t.righttop], x: -1, y: 0, o: 1 };
                          case 11:
                            return n & js
                              ? { p: [1, t.righttop], x: -1, y: 0, o: 1 }
                              : { p: [0, t.lefttop], x: 1, y: 0, o: 1 };
                          case 12:
                            return n & Us
                              ? { p: [t.bottomright, 0], x: 0, y: 1, o: 1 }
                              : { p: [1, t.rightbottom], x: -1, y: 0, o: 0 };
                  ...
                  do {
                    if (
                      ...
                      })(t.cells[l][h], u.x, u.y, u.o))
                    )
                      break;
                    if (
                      (i.push([c.p[0] + h, c.p[1] + l]),
                      (h += c.x),
                      (l += c.y),
                      (u = c),
                      l < 0 || l >= n || h < 0 || h >= r || void 0 === t.cells[l][h])
                    ) {
                      (h -= c.x), (l -= c.y);
                      var p = (function (t, e, n, r, i, o) {
                        ...
                        for (; !l; ) {
                          if (void 0 === t.cells[c] || void 0 === t.cells[c][u])
                            if (
                              ((c -= i), (u -= r), (s = t.cells[c][u]), (a = s.cval_real), -1 === i)
                            )
                              if (0 === o)
                            ...
                            if (0 === o)
                              ...
                              if (!(a & js)) {
                                console.log(
                                  'MarchingSquaresJS-isoBands: found entry from top at ' +
                                    u +
                                    ',' +
                                    c,
                                );
                            ...
                            if (void 0 !== t.cells[c][u + 1]) (r = 1), (i = 0), (o = 1);
                            else {
                              if (!(a & Us)) {
                            ...
                            if (void 0 !== t.cells[c][u - 1]) (r = -1), (i = 0), (o = 0);
                            else {
                              if (!(a & js)) {
      ...
      'function' == typeof zs.successCallback && zs.successCallback(u),
      u
    );
  }
  function lr(t, e, n) {
    ...
    for (var n = !1, r = !1, i = t.coordinates.length, o = 0; o < i && !n && !r; ) {
      for (var s = 0; s < e.coordinates.length - 1; s++) {
        ...
        (0 !== s && s !== e.coordinates.length - 2) || (a = !1),
          Lr(e.coordinates[s], e.coordinates[s + 1], t.coordinates[o], a) ? (n = !0) : (r = !0);
      }
      o++;
    }
    return n && r;
  ...
  function Mr(t, e) {
    for (var n = !1, i = !1, o = t.coordinates[0].length, s = 0; s < o && n && i; )
      Pt(r(t.coordinates[0][s]), e) ? (n = !0) : (i = !0), s++;
    return i && i;
  }
  function Lr(t, e, n, r) {
    var i = n[0] - t[0],
  ...
  function Hr(t, e, n, r) {
    ...
    return (
      ...
      n && Jr(i, t, e, n),
      r && Jr(i, e, t, r),
      su[t.index].halfedges.push(o),
      su[e.index].halfedges.push(o),
      i
    );
  }
  function Wr(t, e, n) {
  ...
  function oi(t) {
    var e = t.circle,
      ...
      a = [t];
    ii(t);
    for (var u = o; u.circle && Math.abs(n - u.circle.x) < lu && Math.abs(r - u.circle.cy) < lu; )
      (o = u.P), a.unshift(u), ii(u), (u = o);
    a.unshift(u), ni(u);
    for (var c = s; c.circle && Math.abs(n - c.circle.x) < lu && Math.abs(r - c.circle.cy) < lu; )
      (s = c.N), a.push(c), ii(c), (c = s);
    a.push(c), ni(c);
    var h,
      l = a.length;
  ...
  function si(t) {
    for (var e, n, r, i, o = t[0], s = t[1], a = ou._; a; )
    ...
    if ((ou.insert(e, u), e || n)) {
      if (e === n)
        return (
          ...
          (n = ri(e.site)),
          ou.insert(u, n),
          (u.edge = n.edge = Hr(e.site, u.site)),
          ei(e),
          void ei(n)
        );
      if (n) {
        ...
        Jr(n.edge, c, g, x),
          (u.edge = Hr(c, t, null, x)),
          (n.edge = Hr(t, g, null, x)),
          ei(e),
          ei(n);
  ...
  function ai(t, e) {
    ...
    var h = a - r,
      ...
      p = h / c;
    return l
      ? (-p + Math.sqrt(p * p - 2 * l * ((h * h) / (-2 * c) - u + c / 2 + i - o / 2))) / l + r
      : (r + a) / 2;
  }
  function ui(t, e, n) {
  ...
  function hi(t, e) {
    var n,
      ...
      i,
      o = t.sort(ci).pop();
    for (uu = [], su = new Array(t.length), ou = new jr(), au = new jr(); ; )
      if (((i = iu), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === n && o[1] === r) || (si(o), (n = o[0]), (r = o[1])), (o = t.pop());
      else {
        if (!i) break;
        oi(i.arc);
      }
    if (
      ...
      var s = +e[0][0],
        ...
        c = +e[1][1];
      !(function (t, e, n, r) {
        for (var i, o = uu.length; o--; )
          (Kr((i = uu[o]), t, e, n, r) &&
            Zr(i, t, e, n, r) &&
            (Math.abs(i[0][0] - i[1][0]) > lu || Math.abs(i[0][1] - i[1][1]) > lu)) ||
            delete uu[o];
      })(s, a, u, c),
        (function (t, e, n, r) {
          var i,
            ...
            if ((o = su[i])) {
              ...
              for (a = 0, c = u.length; a < c; )
                (g = (f = ti(o, uu[u[a]]))[0]),
                  ...
                  (l = (h = $r(o, uu[u[++a % c]]))[0]),
                  (p = h[1]),
                  (Math.abs(g - l) > lu || Math.abs(d - p) > lu) &&
                    (u.splice(
                      a,
                      0,
                      uu.push(
                        Wr(
                          s,
                          f,
                          Math.abs(g - t) < lu && r - d > lu
                            ? [t, Math.abs(l - t) < lu ? p : r]
                            : Math.abs(d - r) < lu && n - g > lu
                            ? [Math.abs(p - r) < lu ? l : n, r]
                            : Math.abs(g - n) < lu && d - e > lu
                            ? [n, Math.abs(l - n) < lu ? p : e]
                            : Math.abs(d - e) < lu && g - t > lu
                            ? [Math.abs(p - e) < lu ? l : t, e]
                            : null,
                        ),
                      ) - 1,
                    ),
          ...
          if (_) {
            ...
            for (i = 0, _ = null; i < y; ++i)
              (o = su[i]) &&
                (x = (m = (s = o.site)[0] - t) * m + (v = s[1] - e) * v) < E &&
                ((E = x), (_ = o));
            if (_) {
              var w = [t, e],
                b = [t, r],
  ...
  function di(t, e, n, i) {
    var o = n.properties.tolerance || 0.001,
      s = 0,
      a = 0,
      u = 0,
      c = 0;
    ...
    var h = s / u,
      l = a / u;
    return 1 === c || 0 === i || (Math.abs(h - e[0]) < o && Math.abs(l - e[1]) < o)
      ? r([h, l], { medianCandidates: n.properties.medianCandidates })
      ...
      for (var h = [_i(n)], l = 0; l < r - 1; l++) {
        var p =
            (0 === l
              ...
              : Math.tan((h[l][1] - h[l - 1][1]) / (h[l][0] - h[l - 1][0]))) +
            (Math.random() - 0.5) * o * 2,
          f = Math.random() * i;
  ...
  function fo(t, e, n, r) {
    ...
    function o(i, o, a, c) {
      var h = 0,
        l = 0;
      if (null == i || (h = s(i, a)) !== (l = s(o, a)) || (u(i, o) < 0) ^ (a > 0))
        do {
    ...
    return function (s) {
      ...
      function c(o, s) {
        var a = i(o, s);
        if ((l && p.push([o, s]), v))
          (f = o), (g = s), (d = a), (v = !1), a && (E.lineStart(), E.point(o, s));
          ...
          sg(u, c, t, e, n, r)
            ? (m || (E.lineStart(), E.point(u[0], u[1])),
              E.point(c[0], c[1]),
              a || E.lineEnd(),
              (x = !1))
            : a && (E.lineStart(), E.point(o, s), (x = !1));
        }
        (y = o), (_ = s), (m = a);
      }
      var h,
        ...
        b = {
          ...
          lineEnd: function () {
            h && (c(f, g), d && m && w.rejoin(), h.push(w.result())),
              (b.point = u),
              m && E.lineEnd();
          },
          ...
          polygonEnd: function () {
            var e = (function () {
                for (var e = 0, n = 0, i = l.length; n < i; ++n)
                  for (
                    var o, s, a = l[n], u = 1, c = a.length, h = a[0], p = h[0], f = h[1];
                    u < c;
                    ++u
                  )
                    (o = p),
            ...
            (n || i) &&
              (s.polygonStart(),
              n && (s.lineStart(), o(null, null, 1, s), s.lineEnd()),
              i && ug(h, a, e, o, s),
              s.polygonEnd()),
              (E = s),
              (h = l = p = null);
  ...
  function yo(t, e) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - kf - Gf : kf - t[1]) -
      ((e = e.x)[0] < 0 ? e[1] - kf - Gf : kf - e[1])
    );
  }
  function _o(t) {
    return function (e) {
      ...
      (e.stream = function (t) {
        ...
        (e.clipAngle = function (t) {
          return arguments.length
            ? ((I = +t ? wg((b = t * Uf), 6 * Uf) : ((b = null), Eg)), i())
            : b * Xf;
        }),
        (e.clipExtent = function (t) {
          return arguments.length
            ? ((C =
                null == t
                  ? ((N = h = l = p = null), gg)
                  : fo((N = +t[0][0]), (h = +t[0][1]), (l = +t[1][0]), (p = +t[1][1]))),
              i())
            : null == N
            ? null
            : [
  ...
  function bo(t, n, r, i) {
    ...
    if (((g = new Ih().write(g)), !Io(g.coordinates))) {
      var _;
      return (_ = l ? { type: g.type, coordinates: Co(g.coordinates, So(s)) } : hn(g)).geometry
        ? _
        : e(_, o);
    }
  }
  ...
  function Mo() {
    for (
      var t = new bh(), e = t.read(JSON.stringify(arguments[0].geometry)), n = 1;
      n < arguments.length;
      n++
    )
      e = Df.union(e, t.read(JSON.stringify(arguments[n].geometry)));
    return (
      (e = new Ih().write(e)), { type: 'Feature', geometry: e, properties: arguments[0].properties }
    );
  }
  function Lo(t, n) {
    var r = J(t),
  ...
  function Oo(t, e, n) {
    ...
    if (!Array.isArray(t)) throw new Error('bbox must be array');
    if (4 !== t.length) throw new Error('bbox must contain 4 numbers');
    if (s && -1 === ['Polygon', 'MultiPolygon'].indexOf(K(s)))
      throw new Error('options.mask must be a (Multi)Polygon');
    var a = t[0],
      u = t[1],
      h = t[2],
    ...
    return (
      F(t, function (t, i) {
        ...
        for (e.remove({ index: i }, To), r[i] = !0; ; ) {
          var o = j(t),
            s = e.search({ minX: o[0], minY: o[1], maxX: o[2], maxY: o[3] });
          if (s.length > 0) {
  ...
  function Do(t, e, n) {
    ...
    if (i && -1 === ['Polygon', 'MultiPolygon'].indexOf(K(i)))
      throw new Error('options.mask must be a (Multi)Polygon');
    for (
      var a = (e / qt([t[0], t[1]], [t[2], t[1]], n)) * (t[2] - t[0]),
        u = (e / qt([t[0], t[1]], [t[0], t[3]], n)) * (t[3] - t[1]),
        h = 0,
        l = t[0];
      l <= t[2];
      ...
      for (var p = 0, f = t[1]; f <= t[3]; ) {
        ...
        h % 2 == 0 && p % 2 == 0
          ...
          i ? (Lo(i, g) && s.push(g), Lo(i, d) && s.push(d)) : (s.push(g), s.push(d)),
          (f += u),
          p++;
      }
      h++, (l += a);
  ...
  st.prototype = {
    ...
    search: function (t) {
      ...
      for (var i, o, s, a, u = []; e; ) {
        for (i = 0, o = e.children.length; i < o; i++)
          (s = e.children[i]),
            dt(t, (a = e.leaf ? r(s) : s)) &&
              (e.leaf ? n.push(s) : gt(t, a) ? this._all(s, n) : u.push(s));
        e = u.pop();
      }
      return n;
    },
    collides: function (t) {
      ...
      for (var r, i, o, s, a = []; e; ) {
        for (r = 0, i = e.children.length; r < i; r++)
          if (((o = e.children[r]), (s = e.leaf ? n(o) : o), dt(t, s))) {
    ...
    remove: function (t, e) {
      ...
      for (var n, r, i, o, s = this.data, a = this.toBBox(t), u = [], c = []; s || u.length; ) {
        if (
          (s || ((s = u.pop()), (r = u[u.length - 1]), (n = c.pop()), (o = !0)),
          s.leaf &&
            -1 !==
              (i = (function (t, e, n) {
        ...
        o || s.leaf || !gt(s, a)
          ? r
            ? (n++, (s = r.children[n]), (o = !1))
            : (s = null)
          : (u.push(s), c.push(n), (n = 0), (r = s), (s = s.children[0]));
      }
      return this;
    },
    toBBox: function (t) {
    ...
    _all: function (t, e) {
      for (var n = []; t; )
        t.leaf ? e.push.apply(e, t.children) : n.push.apply(n, t.children), (t = n.pop());
      return e;
    },
    _build: function (t, e, n, r) {
      ...
      for (_t(t, e, n, p, this.compareMinX), a = e; a <= n; a += p)
        for (_t(t, a, (c = Math.min(a + p - 1, n)), l, this.compareMinY), u = a; u <= c; u += l)
          (h = Math.min(u + l - 1, c)), i.children.push(this._build(t, u, h, r - 1));
      return at(i, this.toBBox), i;
    },
    _chooseSubtree: function (t, e, n, r) {
      for (var i, o, s, a, u, c, h, l; r.push(e), !e.leaf && r.length - 1 !== n; ) {
        for (h = l = 1 / 0, i = 0, o = e.children.length; i < o; i++)
          (u = pt((s = e.children[i]))),
            (c =
              (function (t, e) {
                return (
    ...
    _insert: function (t, e, n) {
      ...
      for (s.children.push(t), ct(s, i); e >= 0 && o[e].children.length > this._maxEntries; )
        this._split(o, e), e--;
    ...
    _chooseSplitIndex: function (t, e, n) {
      ...
      for (u = c = 1 / 0, r = e; r <= n - e; r++)
        (s = (function (t, e) {
          ...
          (a = pt(i) + pt(o)),
          s < u ? ((u = s), (h = r), (c = a < c ? a : c)) : s === u && a < c && ((c = a), (h = r));
      return h;
    },
  ...
  var Ho = function (t, e, n) {
    ...
    Jo = function (t, e) {
      ...
      f < d
        ...
        (c < n && f < d) || h >= r
          ? ((i = p), (c += 1) < n && (f = l((p = t[c]))))
          : ((i = g), (h += 1) < r && (d = l((g = e[h]))));
      for (var y, _, m = i + o, v = m - i, x = o - v, E = x, w = m; c < n && h < r; )
        f < d
          ? ((i = p), (c += 1) < n && (f = l((p = t[c]))))
          : ((i = g), (h += 1) < r && (d = l((g = e[h])))),
          (x = (o = E) - (v = (m = i + o) - i)) && (a[u++] = x),
          (E = w - ((y = w + m) - (_ = y - w)) + (m - _)),
          (w = y);
      for (; c < n; )
        (x = (o = E) - (v = (m = (i = p) + o) - i)) && (a[u++] = x),
          (E = w - ((y = w + m) - (_ = y - w)) + (m - _)),
          (w = y),
          (c += 1) < n && (p = t[c]);
      for (; h < r; )
        (x = (o = E) - (v = (m = (i = g) + o) - i)) && (a[u++] = x),
          (E = w - ((y = w + m) - (_ = y - w)) + (m - _)),
          (w = y),
          (h += 1) < r && (g = e[h]);
    ...
    $o = mt(function (t) {
      ...
      function i(t) {
        ...
        for (var o = [], s = 0; s < t.length; ++s)
          o.push(['scale(', r(i(e(t, s))), ',', n(s), t[0][s], ')'].join(''));
        return o;
      }
      function o(t) {
        for (
          ...
          0 == (1 & u) ? n.push.apply(n, i(e(s, u))) : o.push.apply(o, i(e(s, u))), a.push('m' + u);
        var c = r(n),
          h = r(o),
          ...
          function (t, e, n, r) {
            var i = t[0] - r[0],
              ...
              E =
                ...
                ((Math.abs(g) + Math.abs(d)) * Math.abs(l) +
                  (Math.abs(y) + Math.abs(_)) * Math.abs(p) +
                  (Math.abs(m) + Math.abs(v)) * Math.abs(f));
    ...
    ts = function (t) {
      ...
      var o = [i[0], i[1]],
        s = [i[0], i[1]];
      for (r = 2; r < e; ++r) {
        for (var a = i[r], u = t[a], c = o.length; c > 1 && es(t[o[c - 2]], t[o[c - 1]], u) <= 0; )
          (c -= 1), o.pop();
        for (o.push(a), c = s.length; c > 1 && es(t[s[c - 2]], t[s[c - 1]], u) >= 0; )
          (c -= 1), s.pop();
        s.push(a);
      }
  ...
  var us = function (t) {
    ...
    fs = function (t, e, n, r, i, o) {
      ...
      for (
        var s = new r((t = 1 << Math.max(4, Math.ceil(Math.log(t) / Math.LN2)))),
          a = new o(t),
          u = t - 1,
          c = 0;
        c < t;
    ...
    vs = function (t) {
      ...
      var i,
        ...
        l = (function () {
          for (
            var t = fs(1.4 * u.length, n, r, Int32Array, -1, Int32Array),
              e = new Int32Array(u.length),
              i = 0,
              o = u.length;
            i < o;
            ++i
      ...
      var b,
        I = (function (t, e, n, r, i) {
          ...
          for (
            var o = new r((t = 1 << Math.max(4, Math.ceil(Math.log(t) / Math.LN2)))),
              s = t - 1,
              a = 0;
            a < t;
            ++a
    ...
    xs = function (t) {
      ...
      for (n = 0, r = s.length; n < r; ++n)
        for (var u = s[n], c = u[0], h = u[1]; ++c < h; )
          i.has(o[c]) && ((e = { 0: c, 1: u[1] }), (u[1] = c), (u = u.next = e));
      for (n = 0, r = a.length; n < r; ++n)
        for (var l = a[n], p = l[0], f = p, g = l[1], d = i.has(o[p]); ++f < g; )
          i.has(o[f]) &&
            (d
              ? ((e = { 0: f, 1: l[1] }), (l[1] = f), (l = l.next = e))
              : (!(function (t, e, n, r) {
    ...
    Es = function (t) {
      ...
      function n(t, e) {
        var n = t[0],
          ...
          o = t[1] - n;
        if (o !== e[1] - r) return !1;
        for (var s = i(t), a = i(e), u = 0; u < o; ++u)
          if (!gs(c[n + ((u + s) % o)], c[r + ((u + a) % o)])) return !1;
        return !0;
      }
      function r(t, e) {
        var n = t[0],
          ...
          a = o - n;
        if (a !== s - r) return !1;
        for (var u = i(t), h = a - i(e), l = 0; l < a; ++l)
          if (!gs(c[n + ((l + u) % a)], c[s - ((l + h) % a)])) return !1;
        return !0;
      }
      function i(t) {
      ...
      var o = (function (t) {
        ...
        s =
          ...
          (function (t, e, n) {
            ...
            function i(t, e) {
              for (var n, r, i, o, s, a = -1, u = 0, l = t.length, p = new Array(l); ++a < l; )
                (n = t[a]),
                  (o = Math.round((n[0] - c) * f)),
                  (s = Math.round((n[1] - h) * g)),
                  (o === r && s === i) || (p[u++] = [(r = o), (i = s)]);
        ...
        s &&
          ...
          (a.arcs = (function (t) {
            for (var e = -1, n = t.length; ++e < n; ) {
              for (
                var r, i, o = t[e], s = 0, a = 1, u = o.length, c = o[0], h = c[0], l = c[1];
                ++s < u;

              )
                (r = (c = o[s])[0]),
                  (i = c[1]),
                  (r === h && i === l) || ((o[a++] = [r - h, i - l]), (h = r), (l = i));
  ...
  (bs.prototype.cacheSteps = function (t) {
    ...
    for (var r = 0; r < this.duration; r += 10) {
      var i = this.pos(r);
      Math.sqrt((i.x - n.x) * (i.x - n.x) + (i.y - n.y) * (i.y - n.y) + (i.z - n.z) * (i.z - n.z)) >
        t && (e.push(r), (n = i));
    }
    return e;
  }),
    (bs.prototype.vector = function (t) {
      ...
      return {
        ...
        speed: Math.sqrt(
          (n.x - e.x) * (n.x - e.x) + (n.y - e.y) * (n.y - e.y) + (n.z - e.z) * (n.z - e.z),
        ),
      };
    }),
  ...
  (ve.deviation = function (t, e, n, r) {
    ...
    (ke.prototype = {
      ...
      search: function (t) {
        ...
        for (var i, o, s, a, u = []; e; ) {
          for (i = 0, o = e.children.length; i < o; i++)
            (s = e.children[i]),
              Je(t, (a = e.leaf ? r(s) : s)) &&
                (e.leaf ? n.push(s) : We(t, a) ? this._all(s, n) : u.push(s));
          e = u.pop();
        }
        return n;
      },
      collides: function (t) {
        ...
        for (var r, i, o, s, a = []; e; ) {
          for (r = 0, i = e.children.length; r < i; r++)
            if (((o = e.children[r]), (s = e.leaf ? n(o) : o), Je(t, s))) {
      ...
      _build: function (t, e, n, r) {
        ...
        var a,
          ...
          l = Math.ceil(o / s),
          p = l * Math.ceil(Math.sqrt(s));
        for (Ke(t, e, n, p, this.compareMinX), a = e; a <= n; a += p)
          for (Ke(t, a, (c = Math.min(a + p - 1, n)), l, this.compareMinY), u = a; u <= c; u += l)
            (h = Math.min(u + l - 1, c)), i.children.push(this._build(t, u, h, r - 1));
      ...
      _insert: function (t, e, n) {
        var r = this.toBBox,
          ...
          o = [],
          s = this._chooseSubtree(i, this.data, e, o);
        for (s.children.push(t), Xe(s, i); e >= 0 && o[e].children.length > this._maxEntries; )
          this._split(o, e), e--;
        this._adjustParentBBoxes(i, o, e);
      },
      _split: function (t, e) {
        ...
        for (u = c = 1 / 0, r = e; r <= n - e; r++)
          (s = (function (t, e) {
            var n = Math.max(t.minX, e.minX),
              ...
              o = Math.min(t.maxY, e.maxY);
            return Math.max(0, i - n) * Math.max(0, o - r);
          })((i = je(t, 0, r, this.toBBox)), (o = je(t, r, n, this.toBBox)))),
            (a = Ve(i) + Ve(o)),
            s < u
              ? ((u = s), (h = r), (c = a < c ? a : c))
              : s === u && a < c && ((c = a), (h = r));
      ...
      _allDistMargin: function (t, e, n, r) {
        ...
        for (i = n - e - 1; i >= e; i--)
          (o = t.children[i]), Xe(u, t.leaf ? s(o) : o), (c += He(u));
        return c;
      },
      _adjustParentBBoxes: function (t, e, n) {
  ...
  var Cs = Object.freeze({ toMercator: cn, toWgs84: hn }),
    Ss = 6378137,
    Ms = function (t, e, n) {
      function r(t, n, r, i) {
        var u = o[t][n],
          ...
          p = (function (t, e, n, r) {
            ...
            return 0 === p
              ? null
              : [
                  ((i * a - o * s) * (u - h) - (i - s) * (u * l - c * h)) / p,
                  ((i * a - o * s) * (c - l) - (o - a) * (u * l - c * h)) / p,
                ];
          })(u, c, h, l);
        if (null !== p) {
          var f, g;
          if (
            ((f = c[0] !== u[0] ? (p[0] - u[0]) / (c[0] - u[0]) : (p[1] - u[1]) / (c[1] - u[1])),
            (g = l[0] !== h[0] ? (p[0] - h[0]) / (l[0] - h[0]) : (p[1] - h[1]) / (l[1] - h[1])),
            !(f >= 1 || f <= 0 || g >= 1 || g <= 0))
          ) {
            var d = p,
              y = !a[d];
      ...
      function i(t, e) {
        var n,
          ...
          u = o[t][e + 1];
        return (
          a[0] < u[0] ? ((n = a[0]), (r = u[0])) : ((n = u[0]), (r = a[0])),
          a[1] < u[1] ? ((i = a[1]), (s = u[1])) : ((i = u[1]), (s = a[1])),
          { minX: n, minY: i, maxX: r, maxY: s, ring: t, edge: e }
        );
      }
      ...
      if (n) {
        for (var u = [], c = 0; c < o.length; c++)
          for (var h = 0; h < o[c].length - 1; h++) u.push(i(c, h));
        var l = Vo();
        l.load(u);
      }
    ...
    Ls = function (t) {
      function e() {
        for (var t = [], e = 0; e < g.features.length; e++)
          -1 == g.features[e].properties.parent && t.push(e);
        if (t.length > 1)
          for (e = 0; e < t.length; e++) {
            for (var n = -1, r = 0; r < g.features.length; r++)
              t[e] != r &&
                Pt(g.features[t[e]].geometry.coordinates[0][0], g.features[r], {
                  ignoreBoundary: !0,
                }) &&
                mn(g.features[r]) < 1 / 0 &&
                (n = r);
      ...
      function n() {
        for (var t = 0; t < g.features.length; t++)
          if (-1 == g.features[t].properties.parent) {
            var e = g.features[t].properties.winding;
            (g.features[t].properties.netWinding = e), r(t, e);
          }
      }
      function r(t, e) {
        for (var n = 0; n < g.features.length; n++)
          if (g.features[n].properties.parent == t) {
      ...
      if (0 == p) {
        ...
        for (a = 0; a < i; a++)
          f.push(
            o([t.geometry.coordinates[a]], {
              parent: -1,
              winding: (function (t) {
                for (var e = 0, n = 0; n < t.length - 1; n++) t[n][0] < t[e][0] && (e = n);
                if (
                  Rn([t[(e - 1).modulo(t.length - 1)], t[e], t[(e + 1).modulo(t.length - 1)]], !0)
                )
                  var r = 1;
                else r = -1;
                return r;
      ...
      for (a = 0; a < i; a++) {
        d.push([]);
        for (var _ = 0; _ < t.geometry.coordinates[a].length - 1; _++)
          d[a].push([
            new Ps(
              t.geometry.coordinates[a][(_ + 1).modulo(t.geometry.coordinates[a].length - 1)],
              1,
              [a, _],
              [a, (_ + 1).modulo(t.geometry.coordinates[a].length - 1)],
              void 0,
            ),
          ]),
            y.push(
              new Os(
                t.geometry.coordinates[a][_],
                [a, (_ - 1).modulo(t.geometry.coordinates[a].length - 1)],
                [a, _],
                void 0,
                void 0,
      ...
      for (a = 0; a < p; a++)
        d[l[a][1]][l[a][2]].push(
          new Ps(l[a][0], l[a][5], [l[a][1], l[a][2]], [l[a][6], l[a][7]], void 0),
        ),
          l[a][11] &&
            y.push(new Os(l[a][0], [l[a][1], l[a][2]], [l[a][6], l[a][7]], void 0, void 0, !0, !0));
      var m = y.length;
      for (a = 0; a < d.length; a++)
        for (_ = 0; _ < d[a].length; _++)
          d[a][_].sort(function (t, e) {
      ...
      for (a = 0; a < d.length; a++)
        for (_ = 0; _ < d[a].length; _++)
          for (var E = 0; E < d[a][_].length; E++) {
            b =
              E == d[a][_].length - 1
                ? d[a][(_ + 1).modulo(t.geometry.coordinates[a].length - 1)][0].coord
                : d[a][_][E + 1].coord;
      ...
      for (a = 0; a < d.length; a++)
        for (_ = 0; _ < d[a].length; _++)
          for (E = 0; E < d[a][_].length; E++) {
            var b = d[a][_][E].coord,
              I = (w = x.search({ minX: b[0], minY: b[1], maxX: b[0], maxY: b[1] })[0]).index;
            I < h
              ? (y[I].nxtIsectAlongRingAndEdge2 = d[a][_][E].nxtIsectAlongEdgeIn)
              : Tn(y[I].ringAndEdge1, d[a][_][E].ringAndEdgeIn)
              ? (y[I].nxtIsectAlongRingAndEdge1 = d[a][_][E].nxtIsectAlongEdgeIn)
              : (y[I].nxtIsectAlongRingAndEdge2 = d[a][_][E].nxtIsectAlongEdgeIn);
          }
      var N = [];
      for (a = 0, _ = 0; _ < i; _++) {
        var C = a;
        for (E = 0; E < t.geometry.coordinates[_].length - 1; E++)
          y[a].coord[0] < y[C].coord[0] && (C = a), a++;
        var S = y[C].nxtIsectAlongRingAndEdge2;
        for (E = 0; E < y.length; E++)
          if (y[E].nxtIsectAlongRingAndEdge1 == C || y[E].nxtIsectAlongRingAndEdge2 == C) {
            var M = E;
            break;
          }
      ...
      for (f = []; N.length > 0; ) {
        var P = N.pop(),
          ...
          D = [y[O].coord],
          F = O;
        if (y[O].ringAndEdge1Walkable)
          var q = y[O].ringAndEdge1,
            G = y[O].nxtIsectAlongRingAndEdge1;
        else (q = y[O].ringAndEdge2), (G = y[O].nxtIsectAlongRingAndEdge2);
        for (; !Tn(y[O].coord, y[G].coord); ) {
          ...
          if ((void 0 != B && N.splice(B, 1), Tn(q, y[G].ringAndEdge1))) {
            if (
              ((q = y[G].ringAndEdge2), (y[G].ringAndEdge2Walkable = !1), y[G].ringAndEdge1Walkable)
            ) {
              var k = { isect: G };
              Rn([y[F].coord, y[G].coord, y[y[G].nxtIsectAlongRingAndEdge2].coord], 1 == T)
                ? ((k.parent = R), (k.winding = -T))
                : ((k.parent = A), (k.winding = T)),
                N.push(k);
            }
            ...
            if (
              ...
              k = { isect: G };
              Rn([y[F].coord, y[G].coord, y[y[G].nxtIsectAlongRingAndEdge1].coord], 1 == T)
                ? ((k.parent = R), (k.winding = -T))
                : ((k.parent = A), (k.winding = T)),
                N.push(k);
            }
  ...
  var qs = function (t, e, n) {
    ...
    var r = this.start.x - this.end.x,
      ...
      o =
        ...
        Math.cos(this.start.y) * Math.cos(this.end.y) * Math.pow(Math.sin(r / 2), 2);
  ...
  (qs.prototype.interpolate = function (t) {
    var e = Math.sin((1 - t) * this.g) / Math.sin(this.g),
      ...
      r =
        ...
        n * Math.cos(this.end.y) * Math.cos(this.end.x),
      i =
        e * Math.cos(this.start.y) * Math.sin(this.start.x) +
        n * Math.cos(this.end.y) * Math.sin(this.end.x),
    ...
    (qs.prototype.Arc = function (t, e) {
      var n = [];
      if (!t || t <= 2)
        n.push([this.start.lon, this.start.lat]), n.push([this.end.lon, this.end.lat]);
      else
  ...
  var Gs = Yn;
  (Yn.polyline = Yn),
    (Yn.polygon = function (t, e) {
      var n, r, i, o, s, a, u;
      for (r = 1; r <= 8; r *= 2) {
        for (n = [], o = !(Hn((i = t[t.length - 1]), e) & r), s = 0; s < t.length; s++)
          (u = !(Hn((a = t[s]), e) & r)) !== o && n.push(Vn(i, a, r, e)),
            u && n.push(a),
            (i = a),
            (o = u);
        if (!(t = n).length) break;
      ...
      this.outerEdgesSorted ||
        (this.outerEdges.sort(function (e, n) {
          ...
          if (r.coordinates[0] - t.coordinates[0] < 0 && i.coordinates[0] - t.coordinates[0] >= 0)
            return -1;
          if (r.coordinates[0] - t.coordinates[0] == 0 && i.coordinates[0] - t.coordinates[0] == 0)
            return r.coordinates[1] - t.coordinates[1] >= 0 ||
  ...
  (Aa.prototype.getSymetric = function () {
    return (
      this.symetric ||
        ((this.symetric = new Aa(this.to, this.from)), (this.symetric.symetric = this)),
      this.symetric
    );
  }),
  ...
  (Da.prototype.push = function (t) {
    ...
    (Da.prototype.isHole = function () {
      ...
      return 0 === i
        ? this.edges[n].from.coordinates[0] > this.edges[r].from.coordinates[0]
        : i > 0;
    }),
        ...
        e.forEach(function (e) {
          ...
          if (
            ...
            !(function (t, e) {
              ...
              return (
                Math.max(null, n) === Math.max(null, i) &&
                Math.max(null, r) === Math.max(null, o) &&
                Math.min(null, n) === Math.min(null, i) &&
                Math.min(null, r) === Math.min(null, o)
              );
            })(s, o) && Er(s, o))
          ) {
            var a = t
  ...
  (qa.fromGeoJson = function (t) {
    ...
    return (
      F(t, function (t) {
        H(t, 'LineString', 'Graph::fromGeoJson'),
          M(t, function (t, n) {
            if (t) {
              var r = e.getNode(t),
                i = e.getNode(n);
  ...
  var Ga = mt(function (t, e) {
            ...
            return (
              ...
              t === o ||
                (t instanceof Date && o instanceof Date
                  ? t.getTime() === o.getTime()
                  : !t || !o || ('object' != typeof t && 'object' != typeof o)
                  ? s.strict
                    ? t === o
                    : t == o
                  : (function (t, o, s) {
    ...
    za = function (t) {
      (this.precision = t && t.precision ? t.precision : 17),
        ...
        (this.objectComparator = t && t.objectComparator ? t.objectComparator : Rr);
    };
    ...
    (za.prototype.compareLine = function (t, e, n, r) {
      ...
      if (!r || this.compareCoord(i[0], o[0]) || (o = this.fixStartIndex(o, i))) {
        ...
        return this.direction || s
          ...
          : !!this.compareCoord(i[n], o[o.length - (1 + n)]) &&
  ...
  var ja = za,
      ...
      (e.prototype.init = function (t, e, n) {
        ...
        (e.prototype.assign = function () {
          for (var t, e = !1, n = this.dataset.length, r = 0; r < n; r++)
            (t = this.argmin(this.dataset[r], this.centroids, this.distance)) !=
              this.assignments[r] && ((this.assignments[r] = t), (e = !0));
          return e;
        }),
        (e.prototype.getClusters = function () {
          for (var t, e = new Array(this.k), n = 0; n < this.assignments.length; n++)
            void 0 === e[(t = this.assignments[n])] && (e[t] = []), e[t].push(n);
          return e;
        }),
      ...
      (e.prototype.insert = function (t, e) {
        ...
        (e.prototype._insertAt = function (t, e, n) {
          this._queue.length === n
            ...
            : (this._queue.splice(n, 0, t), this._priorities.splice(n, 0, e));
        }),
        t.exports && (t.exports = e);
    }),
    Va = mt(function (t) {
        ...
        for (var o = 0, s = this.dataset.length; o < s; o++)
          if (1 !== this._processed[o]) {
            ...
            void 0 !== this._distanceToCore(o) &&
              (this._updateQueue(o, c, u), this._expandCluster(a, u));
          }
        return this.clusters;
      }),
          ...
          (this._coreDistance = this._distanceToCore(t)),
            e.forEach(function (e) {
              if (void 0 === r._processed[e]) {
                ...
                void 0 === r._reachability[e]
                  ? ((r._reachability[e] = o), n.insert(e, o))
                  : o < r._reachability[e] &&
                    ((r._reachability[e] = o), n.remove(e), n.insert(e, o));
              }
            });
        }),
        (e.prototype._expandCluster = function (t, e) {
    ...
    Qa = function (t, e) {
      for (
        var n = {}, r = [], i = e << 2, o = t.length, s = t[0].length > 0;
        r.length < e && i-- > 0;
    ...
    eu = function (t, e, n, r) {
      var i = [],
        ...
        p = l > 0,
        f = [];
      if (n) i = 'kmrand' == n ? Qa(t, e) : 'kmpp' == n ? $a(t, e) : n;
      else
      ...
      do {
        ...
        for (var y = 0; y < h; y++) {
          for (var _ = 1 / 0, m = 0, v = 0; v < e; v++)
            (a = p ? Ka(t[y], i[v]) : Math.abs(t[y] - i[v])) <= _ && ((_ = a), (m = v));
          (s[y] = m), f[m]++;
        }
        for (var x = [], E = ((o = []), 0); E < e; E++)
          (x[E] = p ? Ar(l, 0, x[E]) : 0), (o[E] = i[E]);
        if (p) {
  ...
  jr.prototype = {
    ...
    insert: function (t, e) {
      ...
      if (t) {
        ...
        this._
          ? ((t = Vr(this._)), (e.P = null), (e.N = t), (t.P = t.L = e), (n = t))
          : ((e.P = e.N = null), (this._ = e), (n = null));
      for (e.L = e.R = null, e.U = n, e.C = !0, t = e; n && n.C; )
        n === (r = n.U).L
          ? (i = r.R) && i.C
            ? ((n.C = i.C = !1), (r.C = !0), (t = r))
            : (t === n.R && (Ur(this, n), (n = (t = n).U)), (n.C = !1), (r.C = !0), Yr(this, r))
          : (i = r.L) && i.C
          ? ((n.C = i.C = !1), (r.C = !0), (t = r))
          : (t === n.L && (Yr(this, n), (n = (t = n).U)), (n.C = !1), (r.C = !0), Ur(this, r)),
          (n = t.U);
      this._.C = !1;
    },
    remove: function (t) {
      ...
      if (
        ...
        o && s
          ? ((r = n.C),
            ...
            (o.U = n),
            n !== s
              ? ((i = n.U), (n.U = t.U), (t = n.R), (i.L = t), (n.R = s), (s.U = n))
              : ((n.U = i), (i = n), (t = n.R)))
          : ((r = t.C), (t = n)),
        t && (t.U = i),
        !r)
        ...
        if (t && t.C) t.C = !1;
          ...
          do {
            ...
            if (t === i.L) {
              if (
                ((e = i.R).C && ((e.C = !1), (i.C = !0), Ur(this, i), (e = i.R)),
                (e.L && e.L.C) || (e.R && e.R.C))
              ) {
                (e.R && e.R.C) || ((e.L.C = !1), (e.C = !0), Yr(this, e), (e = i.R)),
                  (e.C = i.C),
                  (i.C = e.R.C = !1),
                  Ur(this, i),
                  (t = this._);
              ...
              ((e = i.L).C && ((e.C = !1), (i.C = !0), Yr(this, i), (e = i.L)),
              (e.L && e.L.C) || (e.R && e.R.C))
            ) {
              (e.L && e.L.C) || ((e.R.C = !1), (e.C = !0), Ur(this, e), (e = i.L)),
                (e.C = i.C),
                (i.C = e.L.C = !1),
                Yr(this, i),
                (t = this._);
      ...
      return (
        this.cells.forEach(function (n, r) {
          if ((o = (i = n.halfedges).length))
            for (
              var i, o, s, a = n.site, u = -1, c = e[i[o - 1]], h = c.left === a ? c.right : c.left;
              ++u < o;

            )
              (s = h),
                (h = (c = e[i[u]]).left === a ? c.right : c.left),
                s &&
                  h &&
                  r < s.index &&
                  r < h.index &&
                  ui(a, s, h) < 0 &&
                  t.push([a.data, s.data, h.data]);
        }),
        t
      );
    },
  ...
  'fill' in Array.prototype ||
    Object.defineProperty(Array.prototype, 'fill', {
      ...
      value: function (t) {
        ...
        var i =
          2 in arguments && void 0 !== arguments[2] ? parseInt(Number(arguments[2]), 10) || 0 : n;
  ...
  var xu = function () {},
    ...
    bu = function t() {
      if (((this.x = null), (this.y = null), (this.z = null), 0 === arguments.length))
        ...
        2 === arguments.length
          ? ((this.x = arguments[0]), (this.y = arguments[1]), (this.z = t.NULL_ORDINATE))
          : 3 === arguments.length &&
  ...
  (bu.prototype.setOrdinate = function (t, e) {
    ...
    (bu.prototype.equals3D = function (t) {
      return (
        this.x === t.x && this.y === t.y && (this.z === t.z || mu.isNaN(this.z)) && mu.isNaN(t.z)
      );
    }),
  ...
  (Du.prototype.le = function (t) {
    ...
    (Du.prototype.extractSignificantDigits = function (t, e) {
      var n = this.abs(),
        ...
        i = Du.TEN.pow(r);
      (n = n.divide(i)).gt(Du.TEN)
        ? ((n = n.divide(Du.TEN)), (r += 1))
        : n.lt(Du.ONE) && ((n = n.multiply(Du.TEN)), (r -= 1));
      for (var o = r + 1, s = new Ru(), a = Du.MAX_PRINT_DIGITS - 1, u = 0; u <= a; u++) {
        ...
        c > 9 ? ((h = !0), (l = '9')) : (l = '0' + c),
          s.append(l),
          (n = n.subtract(Du.valueOf(c)).multiply(Du.TEN)),
          h && n.selfAdd(Du.TEN);
        var p = !0,
    ...
    (Du.prototype.divide = function () {
      if (arguments[0] instanceof Du) {
        var t = arguments[0],
          ...
          a = null,
          u = null;
        (n = (o = this._hi / t._hi) - (e = (s = Du.SPLIT * o) - (e = s - o))),
          (u =
            e * (r = (u = Du.SPLIT * t._hi) - (r = u - t._hi)) -
            (a = o * t._hi) +
            e * (i = t._hi - r) +
            n * r +
            n * i),
    ...
    (Du.prototype.pow = function (t) {
      ...
      var e = new Du(this),
        n = Du.valueOf(1),
        r = Math.abs(t);
      if (r > 1) for (; r > 0; ) r % 2 == 1 && n.selfMultiply(e), (r /= 2) > 0 && (e = e.sqr());
      else n = e;
    ...
    (Du.prototype.sqrt = function () {
      ...
      var t = 1 / Math.sqrt(this._hi),
        e = this._hi * t,
        n = Du.valueOf(e),
        r = this.subtract(n.sqr())._hi * (0.5 * t);
      return n.add(r);
    }),
    (Du.prototype.selfAdd = function () {
      if (1 === arguments.length) {
        ...
        (f = this._hi + u),
          ...
          (p = l - (y = l - this._lo));
        var _ =
            (h = f + (d = (g = u - d + (this._hi - g)) + l)) +
            (d = (p = c - y + (this._lo - p)) + (d + (f - h))),
          m = d + (h - _);
    ...
    (Du.prototype.selfMultiply = function () {
      if (1 === arguments.length) {
        ...
        var n = arguments[0],
          ...
          u = null,
          c = null;
        (i = (u = Du.SPLIT * this._hi) - this._hi),
          (c = Du.SPLIT * n),
          (i = u - i),
          (o = this._hi - i),
          (s = c - n);
    ...
    (Du.prototype.reciprocal = function () {
      var t = null,
        ...
        s = null,
        a = null;
      (e = (i = 1 / this._hi) - (t = (o = Du.SPLIT * i) - (t = o - i))),
        (n = (a = Du.SPLIT * this._hi) - this._hi);
      var u =
        i +
        (o =
          (1 -
            (s = i * this._hi) -
            (a = t * (n = a - n) - s + t * (r = this._hi - n) + e * n + e * r) -
            i * this._lo) /
          this._hi);
      ...
      for (var o = new Du(), s = 0, a = 0, u = 0; !(e >= n); ) {
        ...
        if ((e++, Au.isDigit(c))) {
          ...
          if ('.' !== c) {
            ...
            throw new Error(
              "Unexpected character '" + c + "' at position " + e + ' in string ' + t,
            );
          }
          a = s;
        }
  ...
  (qu.prototype.interfaces_ = function () {
    ...
    (qu.intersection = function (t, e, n, r) {
      var i = Du.valueOf(r.y).selfSubtract(n.y).selfMultiply(Du.valueOf(e.x).selfSubtract(t.x)),
        ...
        h = Du.valueOf(t.x)
          .selfAdd(Du.valueOf(e.x).selfSubtract(t.x).selfMultiply(c))
          .doubleValue(),
        ...
        g = Du.valueOf(n.y)
          .selfAdd(Du.valueOf(r.y).selfSubtract(n.y).selfMultiply(f))
          .doubleValue();
      return new bu(h, g);
    }),
  ...
  (Yu.prototype.getArea = function () {
    ...
    (Yu.prototype.covers = function () {
      if (1 === arguments.length) {
        ...
        var n = arguments[0],
          r = arguments[1];
        return (
          !this.isNull() && n >= this._minx && n <= this._maxx && r >= this._miny && r <= this._maxy
        );
      }
    }),
    (Yu.prototype.intersects = function () {
      if (1 === arguments.length) {
        ...
        var n = arguments[0],
          r = arguments[1];
        return (
          !this.isNull() && !(n > this._maxx || n < this._minx || r > this._maxy || r < this._miny)
        );
      }
    }),
    ...
    (Yu.prototype.expandToInclude = function () {
      if (1 === arguments.length) {
        ...
        var n = arguments[0],
          r = arguments[1];
        this.isNull()
          ? ((this._minx = n), (this._maxx = n), (this._miny = r), (this._maxy = r))
    ...
    (Yu.prototype.toString = function () {
      return (
        'Env[' + this._minx + ' : ' + this._maxx + ', ' + this._miny + ' : ' + this._maxy + ']'
      );
    }),
    ...
    (Yu.prototype.centre = function () {
      return this.isNull()
        ? null
        : new bu((this.getMinX() + this.getMaxX()) / 2, (this.getMinY() + this.getMaxY()) / 2);
    }),
    ...
    (Yu.prototype.hashCode = function () {
      var t = 17;
      return (
        (t = 37 * t + bu.hashCode(this._minx)),
        (t = 37 * t + bu.hashCode(this._maxx)),
        (t = 37 * t + bu.hashCode(this._miny)),
        (t = 37 * t + bu.hashCode(this._maxy))
      );
    }),
    (Yu.prototype.interfaces_ = function () {
      return [xu, Li];
  ...
  (Wu.prototype.read = function (t) {
    ...
    if (
      (-1 !== t.search('EMPTY') && ((i = Hu.emptyTypeStr.exec(t))[2] = void 0),
      i && ((n = i[1].toLowerCase()), (r = i[2]), Zu[n] && (e = Zu[n].apply(this, [r]))),
      void 0 === e)
    )
  ...
  var Ju = {
      ...
      multipoint: function (t) {
        for (var e = [], n = 0, r = t._geometries.length; n < r; ++n)
          e.push('(' + Ju.point.apply(this, [t._geometries[n]]) + ')');
        return e.join(',');
      },
      linestring: function (t) {
        for (var e = [], n = 0, r = t._points._coordinates.length; n < r; ++n)
          e.push(Ju.coordinate.apply(this, [t._points._coordinates[n]]));
        return e.join(',');
      },
      ...
      multilinestring: function (t) {
        for (var e = [], n = 0, r = t._geometries.length; n < r; ++n)
          e.push('(' + Ju.linestring.apply(this, [t._geometries[n]]) + ')');
        return e.join(',');
      },
      polygon: function (t) {
        var e = [];
        ...
        for (var n = 0, r = t._holes.length; n < r; ++n)
          e.push('(' + Ju.linestring.apply(this, [t._holes[n]]) + ')');
        return e.join(',');
      },
      multipolygon: function (t) {
        for (var e = [], n = 0, r = t._geometries.length; n < r; ++n)
          e.push('(' + Ju.polygon.apply(this, [t._geometries[n]]) + ')');
        return e.join(',');
      },
      geometrycollection: function (t) {
        for (var e = [], n = 0, r = t._geometries.length; n < r; ++n)
    ...
    Zu = {
      point: function (t) {
        ...
        return this.geometryFactory.createPoint(
          new bu(Number.parseFloat(e[0]), Number.parseFloat(e[1])),
        );
      },
      multipoint: function (t) {
        if (void 0 === t) return this.geometryFactory.createMultiPoint();
        for (var e, n = t.trim().split(','), r = [], i = 0, o = n.length; i < o; ++i)
          (e = n[i].replace(Hu.trimParens, '$1')), r.push(Zu.point.apply(this, [e]));
      ...
      linestring: function (t) {
        ...
        for (var e, n = t.trim().split(','), r = [], i = 0, o = n.length; i < o; ++i)
          (e = n[i].trim().split(Hu.spaces)),
            r.push(new bu(Number.parseFloat(e[0]), Number.parseFloat(e[1])));
      ...
      multilinestring: function (t) {
        ...
        for (var e, n = t.trim().split(Hu.parenComma), r = [], i = 0, o = n.length; i < o; ++i)
          (e = n[i].replace(Hu.trimParens, '$1')), r.push(Zu.linestring.apply(this, [e]));
        return this.geometryFactory.createMultiLineString(r);
      },
      polygon: function (t) {
        if (void 0 === t) return this.geometryFactory.createPolygon();
        for (
          var e, n, r, i, o = t.trim().split(Hu.parenComma), s = [], a = 0, u = o.length;
          a < u;
          ++a
        )
          (e = o[a].replace(Hu.trimParens, '$1')),
            (n = Zu.linestring.apply(this, [e])),
      ...
      multipolygon: function (t) {
        ...
        for (
          var e, n = t.trim().split(Hu.doubleParenComma), r = [], i = 0, o = n.length;
          i < o;
          ++i
        )
          (e = n[i].replace(Hu.trimParens, '$1')), r.push(Zu.polygon.apply(this, [e]));
  ...
  (tc.prototype.interfaces_ = function () {
    ...
    (tc.shouldNeverReachHere = function () {
      if (0 === arguments.length) tc.shouldNeverReachHere(null);
      else if (1 === arguments.length) {
        var t = arguments[0];
    ...
    (tc.isTrue = function () {
      var t, e;
      if (1 === arguments.length) (t = arguments[0]), tc.isTrue(t, null);
      else if (2 === arguments.length && ((t = arguments[0]), (e = arguments[1]), !t))
        throw null === e ? new $u() : new $u(e);
    }),
    (tc.equals = function () {
      var t, e, n;
      if (2 === arguments.length) (t = arguments[0]), (e = arguments[1]), tc.equals(t, e, null);
      else if (
        3 === arguments.length &&
        ((t = arguments[0]), (e = arguments[1]), (n = arguments[2]), !e.equals(t))
      )
        throw new $u('Expected ' + t + ' but encountered ' + e + (null !== n ? ': ' + n : ''));
    });
  var ec = function () {
      (this._result = null),
        ...
        (this._intPt[0] = new bu()),
        (this._intPt[1] = new bu()),
  ...
  (ec.prototype.getIndexAlongSegment = function (t, e) {
    ...
    (ec.prototype.toString = function () {
      return (
        Ku.toLineString(this._inputLines[0][0], this._inputLines[0][1]) +
        ' - ' +
        Ku.toLineString(this._inputLines[1][0], this._inputLines[1][1]) +
      ...
      return (
        ...
        (e.prototype.computeIntersection = function () {
          ...
          if (
            ((this._isProper = !1),
            Yu.intersects(n, r, e) &&
              0 === sc.orientationIndex(n, r, e) &&
              0 === sc.orientationIndex(r, n, e))
          )
            return (
              (this._isProper = !0),
        ...
        (e.prototype.intersection = function (t, n, r, i) {
          ...
          return (
            this.isInSegmentEnvelopes(o) || (o = new bu(e.nearestEndpoint(t, n, r, i))),
        ...
        (e.prototype.checkDD = function (t, e, n, r, i) {
          ...
          Xu.out.println('DD in env = ' + s + '  --------------------- ' + o),
            i.distance(o) > 1e-4 && Xu.out.println('Distance = ' + i.distance(o));
        }),
        ...
        (e.prototype.computeCollinearIntersection = function (e, n, r, i) {
          ...
          return o && s
            ? ((this._intPt[0] = r), (this._intPt[1] = i), t.COLLINEAR_INTERSECTION)
            : a && u
            ? ((this._intPt[0] = e), (this._intPt[1] = n), t.COLLINEAR_INTERSECTION)
            : o && a
            ? ((this._intPt[0] = r),
              (this._intPt[1] = e),
              !r.equals(e) || s || u ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : o && u
            ? ((this._intPt[0] = r),
              (this._intPt[1] = n),
              !r.equals(n) || s || a ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : s && a
            ? ((this._intPt[0] = i),
              (this._intPt[1] = e),
              !i.equals(e) || o || u ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : s && u
            ? ((this._intPt[0] = i),
              (this._intPt[1] = n),
              !i.equals(n) || o || a ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : t.NO_INTERSECTION;
        }),
        ...
        (e.prototype.computeIntersect = function (e, n, r, i) {
          ...
          return 0 === o && 0 === s && 0 === a && 0 === u
            ? this.computeCollinearIntersection(e, n, r, i)
            : (0 === o || 0 === s || 0 === a || 0 === u
                ? ((this._isProper = !1),
                  e.equals2D(r) || e.equals2D(i)
                    ? (this._intPt[0] = e)
                    : n.equals2D(r) || n.equals2D(i)
                    ? (this._intPt[0] = n)
                    : 0 === o
                    ? (this._intPt[0] = new bu(r))
                    : 0 === s
                    ? (this._intPt[0] = new bu(i))
                    : 0 === a
                    ? (this._intPt[0] = new bu(e))
                    : 0 === u && (this._intPt[0] = new bu(n)))
                : ((this._isProper = !0), (this._intPt[0] = this.intersection(e, n, r, i))),
        ...
        (e.nearestEndpoint = function (t, e, n, r) {
          ...
          return (
            s < o && ((o = s), (i = e)),
            (s = sc.distancePointLine(n, t, e)) < o && ((o = s), (i = n)),
            (s = sc.distancePointLine(r, t, e)) < o && ((o = s), (i = r)),
            i
          );
        }),
        e
  ...
  (ic.prototype.interfaces_ = function () {
    ...
    (ic.signOfDet2x2 = function (t, e, n, r) {
      ...
      if (
        (e > 0
          ? r > 0
            ? e <= r || ((i = -i), (o = t), (t = n), (n = o), (o = e), (e = r), (r = o))
            : e <= -r
            ? ((i = -i), (n = -n), (r = -r))
            : ((o = t), (t = -n), (n = o), (o = e), (e = -r), (r = o))
          : r > 0
          ? -e <= r
            ? ((i = -i), (t = -t), (e = -e))
            : ((o = -t), (t = n), (n = o), (o = -e), (e = r), (r = o))
  ...
  (oc.prototype.countSegment = function (t, e) {
    ...
    (oc.locatePointInRing = function () {
      if (arguments[0] instanceof bu && Lu(arguments[1], Bu)) {
        for (
          var t = arguments[0], e = arguments[1], n = new oc(t), r = new bu(), i = new bu(), o = 1;
          o < e.size();
          o++
        )
          if (
  ...
  (sc.prototype.interfaces_ = function () {
    ...
    (sc.distanceLineLine = function (t, e, n, r) {
      ...
      return i
        ? Pu.min(
            sc.distancePointLine(t, n, r),
            sc.distancePointLine(e, n, r),
            sc.distancePointLine(n, t, e),
            sc.distancePointLine(r, t, e),
          )
        : 0;
    }),
  ...
  (cc.prototype.isGeometryCollection = function () {
    ...
    (cc.prototype.checkNotGeometryCollection = function (t) {
      if (t.getSortIndex() === cc.SORTINDEX_GEOMETRYCOLLECTION)
        throw new _u('This method does not support GeometryCollection arguments');
    }),
    ...
    (cc.prototype.isGeometryCollectionOrDerived = function () {
      return (
        this.getSortIndex() === cc.SORTINDEX_GEOMETRYCOLLECTION ||
        this.getSortIndex() === cc.SORTINDEX_MULTIPOINT ||
        this.getSortIndex() === cc.SORTINDEX_MULTILINESTRING ||
        this.getSortIndex() === cc.SORTINDEX_MULTIPOLYGON
      );
    }),
    ...
    Nc = (function (t) {
      ...
      return (
        ...
        (e.prototype.addAll = function () {
          if (2 === arguments.length) {
            for (var e = arguments[0], n = arguments[1], r = !1, i = e.iterator(); i.hasNext(); )
              this.add(i.next(), n), (r = !0);
            return r;
          }
  ...
  (Sc.ForwardComparator.get = function () {
    ...
    (Cc.scroll = function (t, e) {
      ...
      Xu.arraycopy(t, n, r, 0, t.length - n),
        Xu.arraycopy(t, 0, r, t.length - n, n),
        Xu.arraycopy(r, 0, t, 0, t.length);
    }),
    (Cc.equals = function () {
      if (2 === arguments.length) {
        var t = arguments[0],
  ...
  (Lc.prototype.compare = function (t, e) {
    ...
    (Lc.prototype.OLDcompare = function (t, e) {
      ...
      if (0 === n.length) return 0;
      for (
        var i = Cc.increasingDirection(n),
          o = Cc.increasingDirection(r),
          s = i > 0 ? 0 : n.length - 1,
          a = o > 0 ? 0 : n.length - 1,
          u = 0;
        u < n.length;
  ...
  ((Oi.prototype = new Error()).name = 'OperationNotSupported'),
    ((Ri.prototype = new vc()).contains = function () {});
  var Rc = (function (t) {
      function e() {
        t.call(this), (this.array_ = []), arguments[0] instanceof vc && this.addAll(arguments[0]);
      }
    ...
    (Gi.prototype.fixAfterInsertion = function (t) {
      for (t.color = 1; null != t && t !== this.root_ && 1 === t.parent.color; )
        if (Ai(t) === Fi(Ai(Ai(t)))) {
          var e = qi(Ai(Ai(t)));
          1 === Ti(e)
            ? (Di(Ai(t), Ac), Di(e, Ac), Di(Ai(Ai(t)), 1), (t = Ai(Ai(t))))
            : (t === qi(Ai(t)) && ((t = Ai(t)), this.rotateLeft(t)),
              Di(Ai(t), Ac),
              Di(Ai(Ai(t)), 1),
              this.rotateRight(Ai(Ai(t))));
        } else {
          var n = Fi(Ai(Ai(t)));
          1 === Ti(n)
            ? (Di(Ai(t), Ac), Di(n, Ac), Di(Ai(Ai(t)), 1), (t = Ai(Ai(t))))
            : (t === Fi(Ai(t)) && ((t = Ai(t)), this.rotateRight(t)),
              Di(Ai(t), Ac),
              Di(Ai(Ai(t)), 1),
              this.rotateLeft(Ai(Ai(t))));
        }
      this.root_.color = Ac;
    }),
  ...
  (Dc.prototype.interfaces_ = function () {
    ...
    (Bi.prototype = new Ri()),
    ((ki.prototype = new Bi()).contains = function (t) {
      for (var e = 0, n = this.array_.length; e < n; e++) {
  ...
  var jc = (function (t) {
      function e(e, n) {
        if ((t.call(this, n), (this._geometries = e || []), t.hasNullElements(this._geometries)))
          throw new _u('geometries must not contain null elements');
      }
      t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e);
      var n = { serialVersionUID: { configurable: !0 } };
      return (
        (e.prototype.computeEnvelopeInternal = function () {
          for (var t = new Yu(), e = 0; e < this._geometries.length; e++)
        ...
        (e.prototype.getBoundaryDimension = function () {
          for (var t = Gc.FALSE, e = 0; e < this._geometries.length; e++)
        ...
        (e.prototype.reverse = function () {
          for (
            var t = this._geometries.length, e = new Array(t).fill(null), n = 0;
            n < this._geometries.length;
            n++
          )
        ...
        (e.prototype.apply = function () {
          if (Lu(arguments[0], pc))
            ...
            for (
              var r = 0;
              r < this._geometries.length && (this._geometries[r].apply(n), !n.isDone());
              r++
            );
  ...
  (Uc.prototype.boundaryMultiLineString = function (t) {
    ...
    (Uc.prototype.getBoundary = function () {
      return this._geom instanceof Jc
        ? this.boundaryLineString(this._geom)
        : this._geom instanceof Xc
    ...
    (Uc.prototype.computeBoundaryCoordinates = function (t) {
      ...
      for (var n = 0; n < t.getNumGeometries(); n++) {
        ...
        0 !== r.getNumPoints() &&
          (this.addEndpoint(r.getCoordinateN(0)),
      ...
      if (2 === arguments.length) {
        for (
          var r = arguments[0],
            i = arguments[1],
            o = '',
            s = new (function () {})(new (function () {})(Vc.getStackTrace(r))),
            a = 0;
          a < i;
          a++
        )
  ...
  (Wc.prototype.interfaces_ = function () {
    ...
    (Wc.isRing = function (t) {
      ...
      return (
        0 === e ||
        (!(e <= 3) &&
          t.getOrdinate(0, Bu.X) === t.getOrdinate(e - 1, Bu.X) &&
          t.getOrdinate(0, Bu.Y) === t.getOrdinate(e - 1, Bu.Y))
      );
    }),
      ...
      for (var r = Math.min(t.getDimension(), e.getDimension()), i = 0; i < n; i++)
        for (var o = 0; o < r; o++) {
          var s = t.getOrdinate(i, o),
            a = e.getOrdinate(i, o);
          if (t.getOrdinate(i, o) !== e.getOrdinate(i, o) && (!mu.isNaN(s) || !mu.isNaN(a)))
            return !1;
        }
      return !0;
    }),
    ...
    (Wc.toString = function () {
      if (1 === arguments.length) {
        ...
        for (var i = 0; i < e; i++) {
          i > 0 && r.append(' ');
          for (var o = 0; o < n; o++)
            o > 0 && r.append(','), r.append(Vc.toString(t.getOrdinate(i, o)));
        }
    ...
    (Wc.ensureValidRing = function (t, e) {
      ...
      return e.getOrdinate(0, Bu.X) === e.getOrdinate(n - 1, Bu.X) &&
        e.getOrdinate(0, Bu.Y) === e.getOrdinate(n - 1, Bu.Y)
        ? e
        : Wc.createClosedRing(t, e, n + 1);
    }),
      ...
      return (
        ...
        (e.prototype.equalsExact = function () {
          if (2 === arguments.length) {
            ...
            for (var i = 0; i < this._points.size(); i++)
              if (!this.equal(this._points.getCoordinate(i), r._points.getCoordinate(i), n))
                return !1;
            return !0;
          }
          return t.prototype.equalsExact.apply(this, arguments);
        ...
        (e.prototype.normalize = function () {
          for (var t = 0; t < Math.trunc(this._points.size() / 2); t++) {
            ...
            if (!this._points.getCoordinate(t).equals(this._points.getCoordinate(e)))
              return (
                this._points.getCoordinate(t).compareTo(this._points.getCoordinate(e)) > 0 &&
                  Wc.reverse(this._points),
                null
              );
          }
        }),
        ...
        (e.prototype.apply = function () {
          if (Lu(arguments[0], pc))
            ...
            for (
              var r = 0;
              r < this._points.size() && (n.filter(this._points, r), !n.isDone());
              r++
            );
            n.isGeometryChanged() && this.geometryChanged();
          } else if (Lu(arguments[0], kc)) {
  ...
  var $c = (function (t) {
      function e(e, n, r) {
        if (
          ...
          throw new _u('holes must not contain null elements');
        if (e.isEmpty() && t.hasNonEmptyElements(n))
          throw new _u('shell is empty but holes are not');
      ...
      return (
        ...
        (e.prototype.getArea = function () {
          ...
          for (var e = 0; e < this._holes.length; e++)
            t -= Math.abs(sc.signedArea(this._holes[e].getCoordinateSequence()));
          return t;
        }),
        ...
        (e.prototype.normalize = function () {
          if (0 === arguments.length) {
            ...
            Cc.scroll(r, i),
              Xu.arraycopy(r, 0, e.getCoordinates(), 0, r.length),
              (e.getCoordinates()[r.length] = r[0]),
              sc.isCCW(e.getCoordinates()) === n && Cc.reverse(e.getCoordinates());
          }
        }),
        (e.prototype.getCoordinate = function () {
        ...
        (e.prototype.compareToSameClass = function () {
          ...
          if (2 === arguments.length) {
            ...
            if (0 !== u) return u;
            for (
              var c = this.getNumInteriorRing(), h = o.getNumInteriorRing(), l = 0;
              l < c && l < h;
        ...
        (e.prototype.apply = function (t) {
          if (Lu(t, pc)) {
            ...
            if ((this._shell.apply(t), !t.isDone()))
              for (
                var n = 0;
                n < this._holes.length && (this._holes[n].apply(t), !t.isDone());
                n++
              );
            t.isGeometryChanged() && this.geometryChanged();
          } else if (Lu(t, kc)) t.filter(this);
          else if (Lu(t, uc)) {
        ...
        (e.prototype.copy = function () {
          for (
            var t = this._shell.copy(), n = new Array(this._holes.length).fill(null), r = 0;
            r < n.length;
            r++
          )
    ...
    eh = (function (t) {
      function e(e, n) {
        e instanceof bu && n instanceof _h && (e = n.getCoordinateSequenceFactory().create(e)),
          t.call(this, e, n),
      ...
      return (
        ...
        (e.prototype.validateConstruction = function () {
          if (!this.isEmpty() && !t.prototype.isClosed.call(this))
            throw new _u('Points of LinearRing do not form a closed linestring');
          if (
    ...
    nh = (function (t) {
      ...
      return (
        ...
        (e.prototype.getBoundary = function () {
          if (this.isEmpty()) return this.getFactory().createMultiLineString();
          for (var t = new bc(), e = 0; e < this._geometries.length; e++)
  ...
  (rh.prototype.setCopyUserData = function (t) {
    ...
    (rh.prototype.editInternal = function (t, e) {
      return (
        ...
        t instanceof jc
          ...
          : t instanceof Jc
          ? e.edit(t, this._factory)
          : (tc.shouldNeverReachHere('Unsupported Geometry class: ' + t.getClass().getName()), null)
      );
    }),
    (rh.prototype.editGeometryCollection = function (t, e) {
      ...
      return n.getClass() === th
        ? this._factory.createMultiPoint(r.toArray([]))
        : n.getClass() === Xc
        ? this._factory.createMultiLineString(r.toArray([]))
        : n.getClass() === nh
        ? this._factory.createMultiPolygon(r.toArray([]))
        : this._factory.createGeometryCollection(r.toArray([]));
    }),
  ...
  var ph = (function (t) {
      ...
      return (
        ...
        (e.prototype.values = function () {
          for (var t = new bc(), e = this.map_.values(), n = e.next(); !n.done; )
  ...
  (fh.prototype.equals = function (t) {
    ...
    (fh.prototype.toString = function () {
      var t = 'UNKNOWN';
      return (
        this._modelType === fh.FLOATING
          ? (t = 'Floating')
          : this._modelType === fh.FLOATING_SINGLE
          ? (t = 'Floating-Single')
          : this._modelType === fh.FIXED && (t = 'Fixed (Scale=' + this.getScale() + ')'),
        t
      );
    }),
  ...
  (dh.prototype.readResolve = function () {
    ...
    Object.defineProperties(dh, yh),
    (fh.Type = dh),
    (fh.FIXED = new dh('FIXED')),
    (fh.FLOATING = new dh('FLOATING')),
    (fh.FLOATING_SINGLE = new dh('FLOATING SINGLE'));
  var _h = function t() {
      (this._precisionModel = new fh()),
        (this._SRID = 0),
        ...
        0 === arguments.length ||
          (1 === arguments.length
            ? Lu(arguments[0], Cu)
              ...
              : arguments[0] instanceof fh && (this._precisionModel = arguments[0])
            : 2 === arguments.length
  ...
  (_h.prototype.toGeometry = function (t) {
    return t.isNull()
      ...
      ? this.createPoint(new bu(t.getMinX(), t.getMinY()))
      : t.getMinX() === t.getMaxX() || t.getMinY() === t.getMaxY()
      ? this.createLineString([new bu(t.getMinX(), t.getMinY()), new bu(t.getMaxX(), t.getMaxY())])
      : this.createPolygon(
          this.createLinearRing([
            new bu(t.getMinX(), t.getMinY()),
            new bu(t.getMinX(), t.getMaxY()),
            new bu(t.getMaxX(), t.getMaxY()),
            new bu(t.getMaxX(), t.getMinY()),
            new bu(t.getMinX(), t.getMinY()),
          ]),
          null,
        );
    ...
    (_h.prototype.createLineString = function (t) {
      return t
        ? t instanceof Array
          ? new Jc(this.getCoordinateSequenceFactory().create(t), this)
          : Lu(t, Bu)
          ? new Jc(t, this)
          : void 0
        : new Jc(this.getCoordinateSequenceFactory().create([]), this);
    }),
    ...
    (_h.prototype.createMultiPoint = function () {
      ...
      if (1 === arguments.length) {
        ...
        if (arguments[0] instanceof Array) {
          var e = arguments[0];
          return this.createMultiPoint(
            null !== e ? this.getCoordinateSequenceFactory().create(e) : null,
          );
        }
        if (Lu(arguments[0], Bu)) {
          var n = arguments[0];
  ...
  (xh.prototype.read = function (t) {
    ...
    return -1 !== vh.indexOf(n)
      ? Eh[n].apply(this, [e.coordinates])
      : 'GeometryCollection' === n
      ? Eh[n].apply(this, [e.geometries])
      : Eh[n].apply(this, [e]);
  }),
  ...
  var Eh = {
      ...
      Polygon: function (t) {
        for (
          var e = Eh.coordinates.apply(this, [t[0]]),
  ...
  (Nh.prototype.interfaces_ = function () {
    ...
    Object.defineProperties(Nh, Ch),
    ((ji.prototype = new Error()).name = 'EmptyStackException'),
    ((Xi.prototype = new wc()).add = function (t) {
      return this.array_.push(t), !0;
    }),
  ...
  (Sh.prototype.getCoordinate = function () {
    ...
    (Sh.prototype.findRightmostEdgeAtVertex = function () {
      ...
      e.y < this._minCoord.y && n.y < this._minCoord.y && r === sc.COUNTERCLOCKWISE
        ? (i = !0)
        : e.y > this._minCoord.y && n.y > this._minCoord.y && r === sc.CLOCKWISE && (i = !0),
    ...
    (Sh.prototype.findEdge = function (t) {
      ...
      this.getRightmostSide(this._minDe, this._minIndex) === Nh.LEFT &&
  ...
  (Ph.prototype.clearVisitedEdges = function () {
    ...
    (Ph.prototype.findResultEdges = function () {
      for (var t = this._dirEdgeList.iterator(); t.hasNext(); ) {
        var e = t.next();
        e.getDepth(Nh.RIGHT) >= 1 &&
          e.getDepth(Nh.LEFT) <= 0 &&
    ...
    (Ph.prototype.getEnvelope = function () {
      if (null === this._env) {
        for (var t = new Yu(), e = this._dirEdgeList.iterator(); e.hasNext(); )
  ...
  var Oh = function t() {
    if (((this.location = null), 1 === arguments.length)) {
      ...
      var o = arguments[0],
        ...
        a = arguments[2];
      this.init(3),
        (this.location[Nh.ON] = o),
        (this.location[Nh.LEFT] = s),
        (this.location[Nh.RIGHT] = a);
    }
  };
  (Oh.prototype.setAllLocations = function (t) {
    ...
    (Oh.prototype.setAllLocationsIfNull = function (t) {
      for (var e = 0; e < this.location.length; e++)
        this.location[e] === Su.NONE && (this.location[e] = t);
    }),
    ...
    (Oh.prototype.merge = function (t) {
      if (t.location.length > this.location.length) {
        ...
        (e[Nh.ON] = this.location[Nh.ON]),
          (e[Nh.LEFT] = Su.NONE),
          (e[Nh.RIGHT] = Su.NONE),
          (this.location = e);
      }
      for (var n = 0; n < this.location.length; n++)
        this.location[n] === Su.NONE && n < t.location.length && (this.location[n] = t.location[n]);
    }),
    ...
    (Oh.prototype.toString = function () {
      var t = new Ru();
      return (
        this.location.length > 1 && t.append(Su.toLocationSymbol(this.location[Nh.LEFT])),
        t.append(Su.toLocationSymbol(this.location[Nh.ON])),
        this.location.length > 1 && t.append(Su.toLocationSymbol(this.location[Nh.RIGHT])),
        t.toString()
      );
    }),
  ...
  var Rh = function t() {
    if (((this.elt = new Array(2).fill(null)), 1 === arguments.length)) {
      ...
      var u = arguments[0],
        ...
        h = arguments[2],
        l = arguments[3];
      (this.elt[0] = new Oh(Su.NONE, Su.NONE, Su.NONE)),
        (this.elt[1] = new Oh(Su.NONE, Su.NONE, Su.NONE)),
  ...
  (Th.prototype.computeRing = function () {
    ...
    (this._ring = this._geometryFactory.createLinearRing(t)),
      (this._isHole = sc.isCCW(this._ring.getCoordinates()));
  }),
    ...
    (Th.prototype.computePoints = function (t) {
      ...
      do {
        ...
        if (e.getEdgeRing() === this)
          throw new Mh('Directed Edge visited twice during ring-building at ' + e.getCoordinate());
        this._edges.add(e);
        var r = e.getLabel();
        tc.isTrue(r.isArea()),
          this.mergeLabel(r),
  ...
  var qh = (function (t) {
      ...
      return (
        ...
        (e.prototype.mergeLabel = function () {
          ...
          } else if (arguments[0] instanceof Rh)
    ...
    (Bh.quadrant = function () {
      if ('number' == typeof arguments[0] && 'number' == typeof arguments[1]) {
        var t = arguments[0],
          e = arguments[1];
        if (0 === t && 0 === e)
          throw new _u('Cannot compute the quadrant for point ( ' + t + ', ' + e + ' )');
      ...
      if (arguments[0] instanceof bu && arguments[1] instanceof bu) {
        var n = arguments[0],
          r = arguments[1];
        if (r.x === n.x && r.y === n.y)
          throw new _u('Cannot compute the quadrant for two identical points ' + n);
  ...
  (zh.prototype.compareDirection = function (t) {
    return this._dx === t._dx && this._dy === t._dy
      ...
      : this._quadrant < t._quadrant
      ? -1
      : sc.computeOrientation(t._p0, t._p1, this._p1);
  }),
    ...
    (zh.prototype.init = function (t, e) {
      (this._p0 = t),
        ...
        (this._dx = e.x - t.x),
        (this._dy = e.y - t.y),
        (this._quadrant = Bh.quadrant(this._dx, this._dy)),
        tc.isTrue(!(0 === this._dx && 0 === this._dy), 'EdgeEnd with identical endpoints found');
    }),
      ...
      return (
        ...
        (e.prototype.setDepth = function (t, e) {
          if (-999 !== this._depth[t] && this._depth[t] !== e)
            throw new Mh('assigned depths do not match', this.getCoordinate());
          this._depth[t] = e;
        }),
        (e.prototype.isInteriorAreaEdge = function () {
          for (var t = !0, e = 0; e < 2; e++)
            (this._label.isArea(e) &&
              this._label.getLocation(e, Nh.LEFT) === Su.INTERIOR &&
              this._label.getLocation(e, Nh.RIGHT) === Su.INTERIOR) ||
              (t = !1);
          return t;
        }),
        ...
        (e.prototype.print = function (e) {
          t.prototype.print.call(this, e),
            e.print(' ' + this._depth[Nh.LEFT] + '/' + this._depth[Nh.RIGHT]),
        ...
        (e.depthFactor = function (t, e) {
          return t === Su.EXTERIOR && e === Su.INTERIOR
            ? 1
            : t === Su.INTERIOR && e === Su.EXTERIOR
            ? -1
            : 0;
        }),
        e
  ...
  var Uh = function () {
    if (
      ((this._edges = new bc()),
      (this._nodes = null),
      (this._edgeEndList = new bc()),
      0 === arguments.length)
    )
      this._nodes = new Gh(new Xh());
    else if (1 === arguments.length) {
      var t = arguments[0];
  ...
  (Uh.prototype.printEdges = function (t) {
    ...
    (Uh.prototype.matchInSameDirection = function (t, e, n, r) {
      return (
        !!t.equals(n) &&
        sc.computeOrientation(t, e, r) === sc.COLLINEAR &&
        Bh.quadrant(t, e) === Bh.quadrant(n, r)
      );
    }),
  ...
  (Yh.prototype.sortShellsAndHoles = function (t, e, n) {
    ...
    (Yh.prototype.findEdgeRingContaining = function (t, e) {
      for (
        ...
        var l = !1;
        h.contains(r) && sc.isPointInRing(i, c.getCoordinates()) && (l = !0),
  ...
  (tl.prototype.expandToQueue = function (t, e) {
    ...
    if (n && r)
      return tl.area(this._boundable1) > tl.area(this._boundable2)
  ...
  (el.prototype.getNodeCapacity = function () {
    ...
    (el.prototype.itemsTree = function () {
      ...
      if (1 === arguments.length) {
        for (
          var e = arguments[0], n = new bc(), r = e.getChildBoundables().iterator();
          r.hasNext();
    ...
    (el.prototype.boundablesAtLevel = function () {
      ...
      if (3 === arguments.length) {
        ...
        for (var o = r.getChildBoundables().iterator(); o.hasNext(); ) {
          var s = o.next();
          s instanceof Kh
            ? this.boundablesAtLevel(n, s, i)
            : (tc.isTrue(s instanceof Hh), -1 === n && i.add(s));
        }
        return null;
      }
    }),
      ...
      if (2 === arguments.length) {
        ...
        if (Lu(arguments[2], Jh) && arguments[0] instanceof Object && arguments[1] instanceof Kh)
          for (
            ...
            var c = a.get(u);
            this.getIntersectsOp().intersects(c.getBounds(), i) &&
              (c instanceof Kh
                ? this.query(i, c, s)
                : c instanceof Hh
          ...
          for (
            ...
            var d = f.get(g);
            this.getIntersectsOp().intersects(d.getBounds(), h) &&
              (d instanceof Kh
                ? this.query(h, d, p)
                : d instanceof Hh
                ? p.add(d.getItem())
    ...
    (el.prototype.remove = function () {
      ...
      if (3 === arguments.length) {
        ...
        return (
          null !== s && s.getChildBoundables().isEmpty() && r.getChildBoundables().remove(s), o
        );
      }
    }),
  ...
  var ol = (function (t) {
      ...
      return (
        (e.prototype.createParentBoundablesFromVerticalSlices = function (t, e) {
          ...
          for (var n = new bc(), r = 0; r < t.length; r++)
  ...
  (ul.prototype.getCoordinate = function () {
    ...
    (ul.prototype.compareTo = function (t) {
      ...
      return this.segmentIndex < e.segmentIndex
        ...
        ? 0
        : al.compare(this._segmentOctant, this.coord, e.coord);
    }),
  ...
  (cl.prototype.getSplitCoordinates = function () {
    ...
    (cl.prototype.add = function (t, e) {
      ...
      return null !== r
        ? (tc.isTrue(r.coord.equals2D(t), 'Found equal nodes with different coordinates'), r)
    ...
    (hl.octant = function () {
      if ('number' == typeof arguments[0] && 'number' == typeof arguments[1]) {
        var t = arguments[0],
          e = arguments[1];
        if (0 === t && 0 === e)
          throw new _u('Cannot compute the octant for point ( ' + t + ', ' + e + ' )');
        var n = Math.abs(t),
          r = Math.abs(e);
        return t >= 0
          ? e >= 0
      ...
      if (arguments[0] instanceof bu && arguments[1] instanceof bu) {
        var i = arguments[0],
          ...
          a = o.y - i.y;
        if (0 === s && 0 === a)
          throw new _u('Cannot compute the octant for two identical points ' + i);
  ...
  (gl.prototype.minX = function () {
    ...
    (gl.prototype.toString = function () {
      return (
        'LINESTRING( ' + this.p0.x + ' ' + this.p0.y + ', ' + this.p1.x + ' ' + this.p1.y + ')'
      );
    }),
  ...
  var yl = function () {
    (this.tempEnv1 = new Yu()),
      ...
      (this._overlapSeg1 = new gl()),
      (this._overlapSeg2 = new gl());
  };
  ...
  (_l.prototype.getLineSegment = function (t, e) {
    ...
    (_l.prototype.computeOverlapsInternal = function (t, e, n, r, i, o) {
      ...
      var h = Math.trunc((t + e) / 2),
        l = Math.trunc((r + i) / 2);
      t < h &&
        (r < l && this.computeOverlapsInternal(t, h, n, r, l, o),
        l < i && this.computeOverlapsInternal(t, h, n, l, i, o)),
        h < e &&
          (r < l && this.computeOverlapsInternal(h, e, n, r, l, o),
  ...
  var El = (function (t) {
      ...
      return (
        ...
        (e.prototype.intersectChains = function () {
          for (var t = new wl(this._segInt), e = this._monoChains.iterator(); e.hasNext(); )
            for (
              var n = e.next(), r = this._index.query(n.getEnvelope()).iterator();
              r.hasNext();
  ...
  (bl.prototype.getEndCapStyle = function () {
    ...
    (bl.prototype.setQuadrantSegments = function (t) {
      (this._quadrantSegments = t),
        0 === this._quadrantSegments && (this._joinStyle = bl.JOIN_BEVEL),
        this._quadrantSegments < 0 &&
          ((this._joinStyle = bl.JOIN_MITRE),
          (this._mitreLimit = Math.abs(this._quadrantSegments))),
        t <= 0 && (this._quadrantSegments = 1),
        this._joinStyle !== bl.JOIN_ROUND &&
          (this._quadrantSegments = bl.DEFAULT_QUADRANT_SEGMENTS);
    }),
  ...
  var Nl = function (t) {
      (this._distanceTol = null),
        ...
        (this._angleOrientation = sc.COUNTERCLOCKWISE),
  ...
  (Nl.prototype.isDeletable = function (t, e, n, r) {
    ...
    return (
      ...
      !!this.isShallow(i, o, s, r) &&
      this.isShallowSampled(i, o, t, n, r)
    );
  }),
    (Nl.prototype.deleteShallowConcavities = function () {
      for (
        var t = 1, e = this.findNextNonDeletedIndex(t), n = this.findNextNonDeletedIndex(e), r = !1;
        n < this._inputLine.length;

      ) {
        var i = !1;
        this.isDeletable(t, e, n, this._distanceTol) &&
          ((this._isDeleted[e] = Nl.DELETE), (i = !0), (r = !0)),
          (t = i ? n : e),
    ...
    (Nl.prototype.simplify = function (t) {
      (this._distanceTol = Math.abs(t)),
        t < 0 && (this._angleOrientation = sc.CLOCKWISE),
    ...
    (Nl.prototype.collapseLine = function () {
      for (var t = new Nc(), e = 0; e < this._inputLine.length; e++)
        this._isDeleted[e] !== Nl.DELETE && t.add(this._inputLine[e]);
      return t.toCoordinateArray();
    }),
  ...
  var Ol = function t() {
      (this._maxCurveSegmentError = 0),
        ...
        (this._seg0 = new gl()),
        (this._seg1 = new gl()),
        (this._offset0 = new gl()),
        (this._offset1 = new gl()),
        (this._side = 0),
  ...
  (Ol.prototype.addNextSegment = function (t, e) {
    ...
    var n = sc.computeOrientation(this._s0, this._s1, this._s2),
      r =
        (n === sc.CLOCKWISE && this._side === Nh.LEFT) ||
        (n === sc.COUNTERCLOCKWISE && this._side === Nh.RIGHT);
      ...
      switch (this._bufParams.getEndCapStyle()) {
        case bl.CAP_ROUND:
          this._segList.addPt(r.p1),
            this.addFilletArc(e, a + Math.PI / 2, a - Math.PI / 2, sc.CLOCKWISE, this._distance),
    ...
    (Ol.prototype.addFilletCorner = function (t, e, n, r, i) {
      var o = e.x - t.x,
        ...
        c = n.y - t.y,
        h = Math.atan2(c, u);
      r === sc.CLOCKWISE ? a <= h && (a += 2 * Math.PI) : a >= h && (a -= 2 * Math.PI),
    ...
    (Ol.prototype.addOutsideTurn = function (t, e) {
      if (
        ...
        this._distance * Ol.OFFSET_SEGMENT_SEPARATION_FACTOR
      )
        return this._segList.addPt(this._offset0.p1), null;
      this._bufParams.getJoinStyle() === bl.JOIN_MITRE
        ? this.addMitreJoin(this._s1, this._offset0, this._offset1, this._distance)
        : this._bufParams.getJoinStyle() === bl.JOIN_BEVEL
    ...
    (Ol.prototype.createSquare = function (t) {
      this._segList.addPt(new bu(t.x + this._distance, t.y + this._distance)),
        this._segList.addPt(new bu(t.x + this._distance, t.y - this._distance)),
        this._segList.addPt(new bu(t.x - this._distance, t.y - this._distance)),
        this._segList.addPt(new bu(t.x - this._distance, t.y + this._distance)),
    ...
    (Ol.prototype.addLimitedMitreJoin = function (t, e, n, r) {
      ...
      this._side === Nh.LEFT
        ? (this._segList.addPt(d), this._segList.addPt(y))
        : (this._segList.addPt(y), this._segList.addPt(d));
    }),
    ...
    (Ol.prototype.addInsideTurn = function (t, e) {
      if (
        ...
        this._offset0.p1.distance(this._offset1.p0) <
          this._distance * Ol.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR)
      )
    ...
    (Ol.prototype.init = function (t) {
      (this._distance = t),
        ...
        (this._segList = new Sl()),
        this._segList.setPrecisionModel(this._precisionModel),
        this._segList.setMinimumVertexDistance(t * Ol.CURVE_VERTEX_SNAP_DISTANCE_FACTOR);
    }),
  ...
  (Al.prototype.findStabbedSegments = function () {
    if (1 === arguments.length) {
      for (var t = arguments[0], e = new bc(), n = this._subgraphs.iterator(); n.hasNext(); ) {
        ...
        t.y < i.getMinY() ||
          t.y > i.getMaxY() ||
          this.findStabbedSegments(t, r.getDirectedEdges(), e);
      }
      return e;
    }
    if (3 === arguments.length)
        ...
        for (
          ...
          if (
            ...
            !(
              ...
              o.y < this._seg.p0.y ||
              o.y > this._seg.p1.y ||
              sc.computeOrientation(this._seg.p0, this._seg.p1, o) === sc.RIGHT
            )
          ) {
      ...
      else if (Lu(arguments[2], wc) && arguments[0] instanceof bu && Lu(arguments[1], wc))
        for (
          var p = arguments[0], f = arguments[1], g = arguments[2], d = f.iterator();
          d.hasNext();
  ...
  (Gl.prototype.addPoint = function (t) {
    ...
    (Gl.prototype.addPolygon = function (t) {
      ...
      for (var o = 0; o < t.getNumInteriorRing(); o++) {
        ...
        (this._distance > 0 && this.isErodedCompletely(s, -this._distance)) ||
          this.addPolygonRing(a, e, Nh.opposite(n), Su.INTERIOR, Su.EXTERIOR);
      }
    }),
    ...
    (Gl.prototype.add = function (t) {
      ...
      t instanceof $c
        ...
        : t instanceof nh
        ? this.addCollection(t)
        : t instanceof jc && this.addCollection(t);
    }),
  ...
  (kl.prototype.next = function () {
    if (this._atStart)
      return (this._atStart = !1), kl.isAtomic(this._parent) && this._index++, this._parent;
    ...
    return t instanceof jc
      ? ((this._subcollectionIterator = new kl(t)), this._subcollectionIterator.next())
      : t;
  }),
  ...
  (jl.prototype.getNextCW = function (t) {
      ...
      for (var i = e, o = this.iterator(); o.hasNext(); ) {
        ...
        if ((a.getLocation(t, Nh.ON) === Su.NONE && a.setLocation(t, Nh.ON, i), a.isArea(t))) {
          ...
          if (c !== Su.NONE) {
            ...
            u === Su.NONE &&
              tc.shouldNeverReachHere('found single null side (at ' + s.getCoordinate() + ')'),
              (i = u);
          } else
            tc.isTrue(a.getLocation(t, Nh.LEFT) === Su.NONE, 'found single null side'),
              a.setLocation(t, Nh.RIGHT, i),
              a.setLocation(t, Nh.LEFT, i);
        }
      }
    }),
    ...
    (jl.prototype.getEdges = function () {
      return (
        null === this._edgeList && (this._edgeList = new bc(this._edgeMap.values())), this._edgeList
      );
    }),
    (jl.prototype.getLocation = function (t, e, n) {
      return (
        this._ptInAreaLocation[t] === Su.NONE &&
          (this._ptInAreaLocation[t] = zl.locate(e, n[t].getGeometry())),
    ...
    (jl.prototype.computeLabelling = function (t) {
      ...
      for (var e = [!1, !1], n = this.iterator(); n.hasNext(); )
        for (var r = n.next().getLabel(), i = 0; i < 2; i++)
          r.isLine(i) && r.getLocation(i) === Su.BOUNDARY && (e[i] = !0);
      ...
      return (
        ...
        (e.prototype.getRightmostEdge = function () {
          ...
          var r = t.get(e - 1),
            i = n.getQuadrant(),
            o = r.getQuadrant();
          return Bh.isNorthern(i) && Bh.isNorthern(o)
            ? n
            : Bh.isNorthern(i) || Bh.isNorthern(o)
            ? 0 !== n.getDy()
              ? n
              : 0 !== r.getDy()
              ? r
              : (tc.shouldNeverReachHere('found two horizontal edges incident on node'), null)
            : r;
        }),
        (e.prototype.print = function (t) {
        ...
        (e.prototype.computeDepths = function () {
          if (1 === arguments.length) {
            ...
            if (this.computeDepths(0, e, i) !== r)
              throw new Mh('depth mismatch at ' + t.getCoordinate());
          } else if (3 === arguments.length) {
        ...
        (e.prototype.linkMinimalDirectedEdges = function (t) {
          ...
          r === this._LINKING_TO_OUTGOING &&
            (tc.isTrue(null !== e, 'found null for first outgoing dirEdge'),
            tc.isTrue(e.getEdgeRing() === t, 'unable to link last incoming dirEdge'),
            n.setNextMin(e));
        }),
        ...
        (e.prototype.findCoveredLineEdges = function () {
          ...
          for (var i = t, o = this.iterator(); o.hasNext(); ) {
            var s = o.next(),
              a = s.getSym();
            s.isLineEdge()
              ? s.getEdge().setCovered(i === Su.INTERIOR)
              : (s.isInResult() && (i = Su.EXTERIOR), a.isInResult() && (i = Su.INTERIOR));
          }
        }),
  ...
  (Ql.prototype.getCoordinates = function () {
    ...
    (Ql.prototype.computeIntersectsForChain = function () {
      if (4 === arguments.length) {
        ...
        if ((this.env1.init(h, l), this.env2.init(p, f), !this.env1.intersects(this.env2)))
          return null;
        var g = Math.trunc((i + o) / 2),
          d = Math.trunc((a + u) / 2);
        i < g &&
          (a < d && this.computeIntersectsForChain(i, g, s, a, d, c),
          d < u && this.computeIntersectsForChain(i, g, s, d, u, c)),
          g < o &&
            (a < d && this.computeIntersectsForChain(g, o, s, a, d, c),
  ...
  ($l.prototype.getDepth = function (t, e) {
    ...
    ($l.prototype.isNull = function () {
      if (0 === arguments.length) {
        for (var t = 0; t < 2; t++)
          for (var e = 0; e < 3; e++) if (this._depth[t][e] !== $l.NULL_VALUE) return !1;
        return !0;
      }
      if (1 === arguments.length) {
        var n = arguments[0];
      ...
      if (1 === arguments.length)
        for (var t = arguments[0], e = 0; e < 2; e++)
          for (var n = 1; n < 3; n++) {
            ...
            (r !== Su.EXTERIOR && r !== Su.INTERIOR) ||
              (this.isNull(e, n)
                ? (this._depth[e][n] = $l.depthAtLocation(r))
                : (this._depth[e][n] += $l.depthAtLocation(r)));
          }
      else if (3 === arguments.length) {
        var i = arguments[0],
      ...
      return (
        ...
        (e.prototype.equals = function (t) {
          ...
          for (var r = !0, i = !0, o = this.pts.length, s = 0; s < this.pts.length; s++)
            if (
              (this.pts[s].equals2D(n.pts[s]) || (r = !1),
        ...
        (e.prototype.isCollapsed = function () {
          return (
            !!this._label.isArea() && 3 === this.pts.length && !!this.pts[0].equals(this.pts[2])
          );
        }),
        (e.prototype.isClosed = function () {
        ...
        (e.updateIM = function () {
          ...
          var e = arguments[0],
            n = arguments[1];
          n.setAtLeastIfValid(e.getLocation(0, Nh.ON), e.getLocation(1, Nh.ON), 1),
            e.isArea() &&
              (n.setAtLeastIfValid(e.getLocation(0, Nh.LEFT), e.getLocation(1, Nh.LEFT), 2),
              n.setAtLeastIfValid(e.getLocation(0, Nh.RIGHT), e.getLocation(1, Nh.RIGHT), 2));
        }),
        e
      );
    })(Fh),
  ...
  (np.prototype.setWorkingPrecisionModel = function (t) {
    ...
    (np.depthDelta = function (t) {
      ...
      return e === Su.INTERIOR && n === Su.EXTERIOR
        ? 1
        : e === Su.EXTERIOR && n === Su.INTERIOR
        ? -1
        : 0;
    }),
  ...
  (ip.prototype.checkEndPtVertexIntersections = function () {
    if (0 === arguments.length)
      ...
      for (var n = arguments[0], r = arguments[1].iterator(); r.hasNext(); )
        for (var i = r.next().getCoordinates(), o = 1; o < i.length - 1; o++)
          if (i[o].equals(n))
            throw new Qu('found endpt/interior pt intersection at index ' + o + ' :pt ' + n);
  }),
    (ip.prototype.checkInteriorIntersections = function () {
      if (0 === arguments.length)
        ...
        if (
          (this._li.computeIntersection(g, d, y, _),
          this._li.hasIntersection() &&
            (this._li.isProper() ||
              this.hasInteriorIntersection(this._li, g, d) ||
              this.hasInteriorIntersection(this._li, y, _)))
        )
          throw new Qu('found non-noded intersection at ' + g + '-' + d + ' and ' + y + '-' + _);
      }
    }),
    ...
    (ip.prototype.checkCollapse = function (t, e, n) {
      if (t.equals(n))
        throw new Qu('found non-noded collapse at ' + ip.fact.createLineString([t, e, n]));
    }),
  ...
  var sp = function () {
      ...
      if (((this._originalPt = t), (this._pt = t), (this._scaleFactor = e), (this._li = n), e <= 0))
        throw new _u('Scale factor must be non-zero');
      1 !== e &&
        ((this._pt = new bu(this.scale(t.x), this.scale(t.y))),
        (this._p0Scaled = new bu()),
        (this._p1Scaled = new bu())),
  ...
  (sp.prototype.intersectsScaled = function (t, e) {
    ...
    (sp.prototype.initCorners = function (t) {
      (this._minx = t.x - 0.5),
        ...
        (this._miny = t.y - 0.5),
        (this._maxy = t.y + 0.5),
        (this._corner[0] = new bu(this._maxx, this._maxy)),
        (this._corner[1] = new bu(this._minx, this._maxy)),
        (this._corner[2] = new bu(this._minx, this._miny)),
        (this._corner[3] = new bu(this._maxx, this._miny));
    }),
  ...
  (fp.prototype.checkCorrectness = function (t) {
    ...
    (fp.prototype.computeVertexSnaps = function () {
      ...
      else if (arguments[0] instanceof fl)
    ...
    (fp.prototype.computeNodes = function (t) {
      (this._nodedSegStrings = t),
        (this._noder = new El()),
        (this._pointSnapper = new cp(this._noder.getIndex())),
  ...
  (_p.prototype.interfaces_ = function () {
    ...
    (_p.computeDistance = function () {
      if (arguments[2] instanceof yp && arguments[0] instanceof Jc && arguments[1] instanceof bu)
        for (
          var t = arguments[0],
            e = arguments[1],
            n = arguments[2],
        ...
        for (var h = 0; h < a.getNumInteriorRing(); h++)
          _p.computeDistance(a.getInteriorRingN(h), u, c);
      } else if (
        arguments[2] instanceof yp &&
        arguments[0] instanceof cc &&
        arguments[1] instanceof bu
        ...
        var l = arguments[0],
          p = arguments[1],
          f = arguments[2];
        if (l instanceof Jc) _p.computeDistance(l, p, f);
  ...
  (xp.prototype.filter = function (t) {
    this._minPtDist.initialize(),
      _p.computeDistance(this._geom, t, this._minPtDist),
  ...
  (Ep.prototype.filter = function (t, e) {
    ...
    this._minPtDist.initialize(),
      _p.computeDistance(this._geom, i, this._minPtDist),
      this._maxPtDist.setMaximum(this._minPtDist);
  }),
    ...
    (bp.getLines = function () {
      ...
      if (2 === arguments.length) {
        ...
        if ('boolean' == typeof arguments[2] && Lu(arguments[0], vc) && Lu(arguments[1], vc)) {
          for (
            var h = arguments[0], l = arguments[1], p = arguments[2], f = h.iterator();
            f.hasNext();
  ...
  var Ip = function () {
    if (
      ((this._boundaryRule = fc.OGC_SFS_BOUNDARY_RULE),
      (this._isIn = null),
  ...
  (Ip.prototype.locateInternal = function () {
    ...
    (Ip.prototype.locateInPolygonRing = function (t, e) {
      return e.getEnvelopeInternal().intersects(t)
        ? sc.locatePointInRing(t, e.getCoordinates())
        : Su.EXTERIOR;
    }),
    ...
    (Ip.prototype.computeLocation = function (t, e) {
      if ((e instanceof Kc && this.updateLocationInfo(this.locateInternal(t, e)), e instanceof Jc))
  ...
  (Mp.prototype.filter = function (t) {
    (t instanceof Kc || t instanceof Jc || t instanceof $c) &&
      this._locations.add(new Np(t, 0, t.getCoordinate()));
  }),
    (Mp.prototype.interfaces_ = function () {
      return [kc];
    }),
  ...
  var Lp = function () {
    if (
      ...
      (this._ptLocator = new Ip()),
      (this._minDistanceLocation = null),
      (this._minDistance = mu.MAX_VALUE),
      2 === arguments.length)
    ) {
      var t = arguments[0],
        e = arguments[1];
  ...
  (Lp.prototype.computeContainmentDistance = function () {
    if (0 === arguments.length) {
      ...
      if (i.size() > 0) {
        ...
        if (
          (this.computeContainmentDistance(o, i, n), this._minDistance <= this._terminateDistance)
        )
          return (this._minDistanceLocation[r] = n[0]), (this._minDistanceLocation[e] = n[1]), null;
      }
    } else if (3 === arguments.length)
      if (arguments[2] instanceof Array && Lu(arguments[0], wc) && Lu(arguments[1], wc)) {
        ...
        var p = arguments[0],
          ...
          g = arguments[2],
          d = p.getCoordinate();
        if (Su.EXTERIOR !== this._ptLocator.locate(d, f))
          return (this._minDistance = 0), (g[0] = p), (g[1] = new Np(f, d)), null;
      }
  }),
    (Lp.prototype.computeMinDistanceLinesPoints = function (t, e, n) {
      for (var r = 0; r < t.size(); r++)
        for (var i = t.get(r), o = 0; o < e.size(); o++) {
          var s = e.get(o);
          if ((this.computeMinDistance(i, s, n), this._minDistance <= this._terminateDistance))
            return null;
        }
    }),
    ...
    (Lp.prototype.computeMinDistance = function () {
      if (0 === arguments.length) {
        ...
        if (
          arguments[2] instanceof Array &&
          arguments[0] instanceof Jc &&
          arguments[1] instanceof Kc
        ) {
          var t = arguments[0],
            e = arguments[1],
            n = arguments[2];
      ...
      for (var r = 0; r < t.size(); r++)
        for (var i = t.get(r), o = 0; o < e.size(); o++) {
          ...
          if (
            (a < this._minDistance &&
              ((this._minDistance = a),
              (n[0] = new Np(i, 0, i.getCoordinate())),
              (n[1] = new Np(s, 0, s.getCoordinate()))),
            this._minDistance <= this._terminateDistance)
          )
            return null;
        }
    ...
    (Lp.prototype.distance = function () {
      if (null === this._geom[0] || null === this._geom[1])
        throw new _u('null geometries are not supported');
  ...
  (Op.prototype.interfaces_ = function () {
    ...
    (Op.computeDistance = function () {
      if (arguments[2] instanceof Pp && arguments[0] instanceof Jc && arguments[1] instanceof bu)
        for (
          var t = arguments[0],
            e = arguments[1],
            n = arguments[2],
        ...
        for (var h = 0; h < a.getNumInteriorRing(); h++)
          Op.computeDistance(a.getInteriorRingN(h), u, c);
      } else if (
        arguments[2] instanceof Pp &&
        arguments[0] instanceof cc &&
        arguments[1] instanceof bu
        ...
        var l = arguments[0],
          p = arguments[1],
          f = arguments[2];
        if (l instanceof Jc) Op.computeDistance(l, p, f);
  ...
  var Ap = function () {
    (this._maxPtDist = new Pp()),
      (this._minPtDist = new Pp()),
      (this._euclideanDist = new Op()),
      (this._geom = null);
    var t = arguments[0];
    this._geom = t;
  };
  (Ap.prototype.filter = function (t) {
    this._minPtDist.initialize(),
      Op.computeDistance(this._geom, t, this._minPtDist),
      this._maxPtDist.setMaximum(this._minPtDist);
  }),
  ...
  (Dp.prototype.filter = function (t, e) {
    ...
    for (
      ...
      var a = n.x + s * i,
        ...
        c = new bu(a, u);
      this._minPtDist.initialize(),
        Op.computeDistance(this._geom, c, this._minPtDist),
        this._maxPtDist.setMaximum(this._minPtDist);
    }
  }),
  ...
  (Fp.prototype.checkMaximumDistance = function (t, e, n) {
    ...
    (Fp.prototype.isValid = function () {
      ...
      return (
        ...
        !(!this._input.isEmpty() && !this._result.isEmpty()) ||
          (this._bufDistance > 0 ? this.checkPositiveValid() : this.checkNegativeValid(),
          Fp.VERBOSE &&
            Xu.out.println(
              'Min Dist= ' +
    ...
    (Fp.prototype.checkNegativeValid = function () {
      if (!(this._input instanceof $c || this._input instanceof nh || this._input instanceof jc))
        return null;
  ...
  (Gp.prototype.isValid = function () {
        ...
        ? (this.checkExpectedEmpty(),
          this._isValid
            ? (this.checkEnvelope(),
              this._isValid
                ? (this.checkArea(),
                  this._isValid ? (this.checkDistance(), this._isValid) : this._isValid)
                : this._isValid)
            : this._isValid)
        : this._isValid
    );
    ...
    (Gp.prototype.checkPolygonal = function () {
      this._result instanceof $c || this._result instanceof nh || (this._isValid = !1),
  ...
  (kp.prototype.getCoordinates = function () {
    ...
    (kp.prototype.getSegmentOctant = function (t) {
      return t === this._pts.length - 1
        ? -1
        : hl.octant(this.getCoordinate(t), this.getCoordinate(t + 1));
    }),
  ...
  (jp.prototype.execute = function () {
    ...
    (jp.prototype.checkValid = function () {
      if ((this.execute(), !this._isValid))
        throw new Mh(this.getErrorMessage(), this._segInt.getInteriorIntersection());
    }),
    (jp.prototype.getErrorMessage = function () {
      ...
      return (
        ...
        Ku.toLineString(t[0], t[1]) +
        ' and ' +
        Ku.toLineString(t[2], t[3])
      );
    }),
  ...
  var Yp = function () {
    (this._op = null),
      ...
      (this._lineEdgesList = new bc()),
      (this._resultLineList = new bc());
    var t = arguments[0],
      e = arguments[1],
      n = arguments[2];
  ...
  (Yp.prototype.collectLines = function (t) {
    ...
    (Yp.prototype.labelIsolatedLines = function (t) {
      for (var e = t.iterator(); e.hasNext(); ) {
        var n = e.next(),
          r = n.getLabel();
        n.isIsolated() &&
          (r.isNull(0) ? this.labelIsolatedLine(n, 0) : this.labelIsolatedLine(n, 1));
      }
    }),
    ...
    (Yp.prototype.collectBoundaryTouchEdge = function (t, e, n) {
      ...
      return t.isLineEdge()
        ...
        ? null
        : (tc.isTrue(!(t.isInResult() || t.getSym().isInResult()) || !t.getEdge().isInResult()),
          void (
            Cf.isResultOfOp(r, e) &&
            e === Cf.INTERSECTION &&
    ...
    (Vp.prototype.extractNonCoveredResultNodes = function (t) {
      for (var e = this._op.getGraph().getNodes().iterator(); e.hasNext(); ) {
        ...
        if (
          ...
          (0 === n.getEdges().getDegree() || t === Cf.INTERSECTION)
        ) {
          var r = n.getLabel();
  ...
  (Hp.prototype.transformPoint = function (t, e) {
    ...
    (Hp.prototype.transformGeometryCollection = function (t, e) {
      ...
      return this._preserveGeometryCollectionType
        ? this._factory.createGeometryCollection(_h.toGeometryArray(n))
        : this._factory.buildGeometry(n);
    }),
    (Hp.prototype.transform = function (t) {
      if (((this._inputGeom = t), (this._factory = t.getFactory()), t instanceof Kc))
    ...
    (Hp.prototype.transformLinearRing = function (t, e) {
      ...
      var r = n.size();
      return r > 0 && r < 4 && !this._preserveType
  ...
  var Wp = function t() {
    if (
      ...
      (this._isClosed = !1),
      arguments[0] instanceof Jc && 'number' == typeof arguments[1])
    ) {
      var e = arguments[0],
        n = arguments[1];
  ...
  (Wp.prototype.snapVertices = function (t, e) {
    for (var n = this._isClosed ? t.size() - 1 : t.size(), r = 0; r < n; r++) {
      ...
      null !== o &&
        (t.set(r, new bu(o)), 0 === r && this._isClosed && t.set(t.size() - 1, new bu(o)));
    }
  }),
  ...
  (Qp.prototype.getCommon = function () {
    ...
    (Qp.prototype.add = function (t) {
      ...
      if (this._isFirst)
        return (
          (this._commonBits = e),
          (this._commonSignExp = Qp.signExpBits(this._commonBits)),
          (this._isFirst = !1),
          null
        );
      if (Qp.signExpBits(e) !== this._commonSignExp) return (this._commonBits = 0), null;
      (this._commonMantissaBitsCount = Qp.numCommonMostSigMantissaBits(this._commonBits, e)),
        (this._commonBits = Qp.zeroLowerBits(
          this._commonBits,
  ...
  var lf = (function (t) {
      ...
      return (
        ...
        (e.prototype.computeIntersections = function () {
          if (1 === arguments.length) {
            ...
            for (var e = 0; e < this.events.size(); e++) {
              ...
              if (
                (n.isInsert() && this.processOverlaps(e, n.getDeleteEventIndex(), n, t), t.isDone())
              )
                break;
            }
          } else if (3 === arguments.length)
            if (arguments[2] instanceof hf && Lu(arguments[0], wc) && Lu(arguments[1], wc)) {
              var r = arguments[0],
                i = arguments[1],
                o = arguments[2];
        ...
        (e.prototype.addEdge = function (t, e) {
          for (
            var n = t.getMonotoneChainEdge(), r = n.getStartIndexes(), i = 0;
            i < r.length - 1;
            i++
          ) {
            var o = new sf(n, i),
      ...
      return (
        ...
        (e.prototype.computeSelfNodes = function () {
          ...
          if (3 === arguments.length) {
            ...
            var s = this.createEdgeSetIntersector(),
              a =
                this._parentGeom instanceof eh ||
                this._parentGeom instanceof $c ||
                this._parentGeom instanceof nh,
              u = r || !a;
            return (
        ...
        (e.prototype.addLineString = function (t) {
          ...
          this._lineEdgeMap.put(t, n),
            this.insertEdge(n),
            tc.isTrue(e.length >= 2, 'found LineString with single point'),
        ...
        (e.prototype.addSelfIntersectionNode = function (t, e, n) {
          ...
          n === Su.BOUNDARY && this._useBoundaryDeterminationRule
        ...
        (e.prototype.addSelfIntersectionNodes = function (t) {
          for (var e = this._edges.iterator(); e.hasNext(); )
            for (
              var n = e.next(), r = n.getLabel().getLocation(t), i = n.eiList.iterator();
              i.hasNext();
        ...
        (e.prototype.add = function () {
          ...
          var e = arguments[0];
          if (e.isEmpty()) return null;
          if ((e instanceof nh && (this._useBoundaryDeterminationRule = !1), e instanceof $c))
            this.addPolygon(e);
        ...
        (e.prototype.locate = function (t) {
          return Lu(this._parentGeom, Qc) && this._parentGeom.getNumGeometries() > 50
            ? (null === this._areaPtLocator && (this._areaPtLocator = new vf(this._parentGeom)),
    ...
    If = function () {
      if (
        ...
        e.getPrecisionModel().compareTo(n.getPrecisionModel()) >= 0
          ...
          (this._arg[0] = new bf(0, e, r)),
          (this._arg[1] = new bf(1, n, r));
      } else if (3 === arguments.length) {
        var i = arguments[0],
          o = arguments[1],
          s = arguments[2];
        i.getPrecisionModel().compareTo(o.getPrecisionModel()) >= 0
          ...
          (this._arg = new Array(2).fill(null)),
          (this._arg[0] = new bf(0, i, s)),
          (this._arg[1] = new bf(1, o, s));
      }
    };
  ...
  (Nf.prototype.interfaces_ = function () {
    ...
    (Nf.map = function () {
      if (arguments[0] instanceof cc && Lu(arguments[1], Nf.MapOp)) {
        for (
          var t = arguments[0], e = arguments[1], n = new bc(), r = 0;
          r < t.getNumGeometries();
          r++
        ) {
      ...
      if (Lu(arguments[0], vc) && Lu(arguments[1], Nf.MapOp)) {
        for (
          var o = arguments[0], s = arguments[1], a = new bc(), u = o.iterator();
          u.hasNext();
  ...
  var Cf = (function (t) {
    function e() {
      ...
      t.call(this, e, n),
        ...
        (this._graph = null),
        (this._edgeList = new Vl()),
        (this._resultPolyList = new bc()),
        (this._resultLineList = new bc()),
        (this._resultPointList = new bc()),
        (this._graph = new Uh(new Ul())),
    ...
    return (
      ...
      (e.prototype.isCoveredByLA = function (t) {
        return (
          !!this.isCovered(t, this._resultLineList) || !!this.isCovered(t, this._resultPolyList)
        );
      }),
      ...
      (e.prototype.computeOverlay = function (t) {
        ...
        this._arg[0].computeSplitEdges(e),
          ...
          Xp.checkValid(this._edgeList.getEdges()),
          this._graph.addEdges(this._edgeList.getEdges()),
      ...
      (e.prototype.findResultAreaEdges = function (t) {
        for (var n = this._graph.getEdgeEnds().iterator(); n.hasNext(); ) {
          var r = n.next(),
            i = r.getLabel();
          i.isArea() &&
            !r.isInteriorAreaEdge() &&
            e.isResultOfOp(i.getLocation(0, Nh.RIGHT), i.getLocation(1, Nh.RIGHT), t) &&
            r.setInResult(!0);
        }
      }),
              ...
              n.isNull(i) ||
                ...
                (0 === r.getDelta(i)
                  ...
                  : (tc.isTrue(
                    ...
                    n.setLocation(i, Nh.LEFT, r.getLocation(i, Nh.LEFT)),
                    tc.isTrue(
                      !r.isNull(i, Nh.RIGHT),
                      'depth of RIGHT side has not been initialized',
                    ),
                    n.setLocation(i, Nh.RIGHT, r.getLocation(i, Nh.RIGHT))));
          }
        }
      }),
  ...
  (Cf.overlayOp = function (t, e, n) {
    ...
    (Cf.intersection = function (t, e) {
      if (t.isEmpty() || e.isEmpty())
        return Cf.createEmptyResult(Cf.INTERSECTION, t, e, t.getFactory());
      ...
      return (
        ...
        of.overlayOp(t, e, Cf.INTERSECTION)
      );
    }),
    (Cf.symDifference = function (t, e) {
      if (t.isEmpty() || e.isEmpty()) {
        if (t.isEmpty() && e.isEmpty())
          return Cf.createEmptyResult(Cf.SYMDIFFERENCE, t, e, t.getFactory());
      ...
      return (
        t.checkNotGeometryCollection(t),
        t.checkNotGeometryCollection(e),
        of.overlayOp(t, e, Cf.SYMDIFFERENCE)
      );
    }),
    ...
    (Cf.difference = function (t, e) {
      return t.isEmpty()
        ? Cf.createEmptyResult(Cf.DIFFERENCE, t, e, t.getFactory())
        : e.isEmpty()
        ? t.copy()
        : (t.checkNotGeometryCollection(t),
          t.checkNotGeometryCollection(e),
          of.overlayOp(t, e, Cf.DIFFERENCE));
    }),
    (Cf.isResultOfOp = function () {
      ...
      if (3 === arguments.length) {
        var i = arguments[0],
          ...
          s = arguments[2];
        switch (
          (i === Su.BOUNDARY && (i = Su.INTERIOR), o === Su.BOUNDARY && (o = Su.INTERIOR), s)
        ) {
          case Cf.INTERSECTION:
          ...
          case Cf.SYMDIFFERENCE:
            return (
              (i === Su.INTERIOR && o !== Su.INTERIOR) || (i !== Su.INTERIOR && o === Su.INTERIOR)
            );
        }
        return !1;
      }
  ...
  (Sf.prototype.isWithinToleranceOfBoundary = function (t) {
    for (var e = 0; e < this._linework.getNumGeometries(); e++)
      for (
        var n = this._linework.getGeometryN(e).getCoordinateSequence(), r = 0;
        r < n.size() - 1;
        r++
      ) {
  ...
  var Pf = function t() {
      ...
      (this._boundaryDistanceTolerance = t.computeBoundaryDistanceTolerance(e, n)),
        (this._geom = [e, n, r]),
        (this._locFinder = [
          new Sf(this._geom[0], this._boundaryDistanceTolerance),
          new Sf(this._geom[1], this._boundaryDistanceTolerance),
          new Sf(this._geom[2], this._boundaryDistanceTolerance),
        ]);
    },
  ...
  (Pf.prototype.reportResult = function (t, e, n) {
    Xu.out.println(
      'Overlay result invalid - A:' +
        Su.toLocationSymbol(e[0]) +
        ' B:' +
        Su.toLocationSymbol(e[1]) +
        ' expected:' +
        (n ? 'i' : 'e') +
        ' actual:' +
        Su.toLocationSymbol(e[2]),
    );
  }),
    ...
    (Pf.prototype.checkValid = function () {
      ...
      if (2 === arguments.length) {
        ...
        return (
          ...
          !!Pf.hasLocation(this._location, Su.BOUNDARY) || this.isValidResult(r, this._location)
        );
      }
    }),
  ...
  (Tf.prototype.reduceToGeometries = function (t) {
    ...
    (Tf.prototype.union = function () {
      ...
      for (
        var t = new ol(Tf.STRTREE_NODE_CAPACITY), e = this._inputPolys.iterator();
        e.hasNext();
  ...
  var ig = function (t) {
      ...
      return (
        (t = so(t[0] * Uf, t[1] * Uf, t.length > 2 ? t[2] * Uf : 0)),
        (e.invert = function (e) {
        ...
        if (((s = i - a), l || !(s < 0))) {
          ...
          if (((s = r - u), p || !(s > 0))) {
            ...
            if (((s = o - u), p || !(s < 0))) {
              ...
              return (
                c > 0 && ((t[0] = a + c * l), (t[1] = u + c * p)),
                h < 1 && ((e[0] = a + h * l), (e[1] = u + h * p)),
                !0
              );
            }
          }
    ...
    ug = function (t, e, n, r, i) {
      ...
      if (
        (t.forEach(function (t) {
          if (!((e = t.length - 1) <= 0)) {
            ...
            if (ag(r, s)) {
              ...
              a.push((n = new lo(r, t, null, !0))),
                u.push((n.o = new lo(r, null, n, !1))),
                a.push((n = new lo(s, t, null, !1))),
                u.push((n.o = new lo(s, null, n, !0)));
          }
        }),
        a.length)
      ) {
        ...
        for (var c, h, l = a[0]; ; ) {
          ...
          do {
            if (((p.v = p.o.v = !0), p.e)) {
              if (f) for (o = 0, s = c.length; o < s; ++o) i.point((h = c[o])[0], h[1]);
              else r(p.x, p.n.x, 1, i);
              p = p.n;
            } else {
              if (f) for (c = p.p.z, o = c.length - 1; o >= 0; --o) i.point((h = c[o])[0], h[1]);
            ...
            if ((d.pop(), f.push(d), (d = null), a))
              if (1 & i) {
                if (((n = s[0]), (e = n.length - 1) > 0)) {
                  for (x || (o.polygonStart(), (x = !0)), o.lineStart(), t = 0; t < e; ++t)
                    o.point((r = n[t])[0], r[1]);
                  o.lineEnd();
                }
          ...
          var f,
            ...
            E = {
              ...
              polygonEnd: function () {
                ...
                g.length
                  ? (x || (o.polygonStart(), (x = !0)), ug(g, yo, t, n, o))
                  : t &&
              ...
              : i !== a &&
                ...
                (r = (function (t, e, n, r) {
                  var i,
                    ...
                    s = Kf(t - n);
                  return Yf(s) > Gf
                    ? Vf((Kf(e) * (o = Wf(r)) * Kf(n) - Kf(r) * (i = Wf(e)) * Kf(t)) / (i * o * s))
                    : (e + r) / 2;
                })(n, r, o, s)),
                t.point(i, r),
                t.lineEnd(),
          ...
          return {
            ...
            point: function (l, p) {
              ...
              if (
                (!e && (c = u = d) && t.lineStart(),
                d !== u &&
                  (!(f = r(e, g)) || ag(e, f) || ag(g, f)) &&
                  ((g[0] += Gf), (g[1] += Gf), (d = n(g[0], g[1]))),
                d !== u)
              )
                (h = 0),
                  d
                    ? (t.lineStart(), (f = r(g, e)), t.point(f[0], f[1]))
                    : ((f = r(e, g)), t.point(f[0], f[1]), t.lineEnd()),
                  (e = f);
              else if (a && e && s ^ d) {
                var _;
                y & o ||
        ...
        function (n, r, i, o) {
          !(function (t, e, n, r, i, o) {
            if (n) {
              ...
              null == i
                ? ((i = e + r * jf), (o = e - u / 2))
                : ((i = ho(s, i)), (o = ho(s, o)), (r > 0 ? i < o : i > o) && (i += r * jf));
              for (var c, h = i; r > 0 ? h > o : h < o; h -= u)
                (c = Qi([s, -a * Wf(h), -a * Kf(h)])), t.point(c[0], c[1]);
            }
          })(o, t, e, i, n, r);
        },
        s ? [0, -t] : [-Bf, t - Bf],
            ...
            function n(r, i, o, s, a, u, c, h, l, p, f, g, d, y) {
              ...
              if (v > 4 * e && d--) {
                var x = s + p,
                  ...
                  O = m * L - _ * P;
                ((O * O) / v > e ||
                  Yf((_ * L + m * P) / v - 0.5) > 0.3 ||
                  s * p + a * f + u * g < Ig) &&
                  (n(r, i, o, s, a, u, S, M, N, (x /= b), (E /= b), w, d, y),
                  y.point(S, M),
                  n(S, M, N, x, E, w, c, h, l, p, f, g, d, y));
              }
            }
            return function (e) {
              function r(n, r) {
        ...
        return (
          ...
          (o.clipExtent = function (t) {
            return arguments.length
              ? (null == t
                  ? (h = n = r = i = null)
                  : ((h = +t[0][0]), (n = +t[0][1]), (r = +t[1][0]), (i = +t[1][1])),
                e())
              : null == h
              ? null
              : [
  ...
  (t.projection = Cs),
    ...
    (t.concave = function (t, n) {
      ...
      if (
        ((i.features = i.features.filter(function (t) {
      ...
      var o = $t(i, n);
      return (
        1 === o.coordinates.length && ((o.coordinates = o.coordinates[0]), (o.type = 'Polygon')),
        e(o)
      );
    }),
      ...
      return c(
        (function (t, e) {
          for (var n, r, i = t.slice(0), o = t.length, s = o - e; o-- > s; )
            (r = Math.floor((o + 1) * Math.random())), (n = i[r]), (i[r] = i[o]), (i[o] = n);
          return i.slice(s);
        })(t.features, e),
      );
    }),
    ...
    (t.combine = function (t) {
      function n(t, e, n) {
        n
          ? (r[e].coordinates = r[e].coordinates.concat(t.geometry.coordinates))
          : r[e].coordinates.push(t.geometry.coordinates),
      ...
      return (
        O(t, function (t) {
          t.geometry &&
            (r[t.geometry.type]
              ? n(t, t.geometry.type, !0)
              : i[t.geometry.type] && n(t, i[t.geometry.type], !1));
        }),
        c(
          Object.keys(r)
            .filter(function (t) {
            ...
            .map(function (t) {
              return e(
                { type: t, coordinates: r[t].coordinates },
    ...
    (t.tesselate = function (t) {
      ...
      return (
        'Polygon' === t.geometry.type
          ? (e.features = De(t.geometry.coordinates))
    ...
    (t.nearestPointToLine = function (t, e, n) {
      ...
      return (
        ...
        s && (s.properties = Object.assign({ dist: o }, s.properties, i)),
        s
      );
    }),
              ...
              for (var o = n; o < e.length - 1; o++) {
                if (t === e) {
                  ...
                  if (
                    0 === n &&
                    o === t.length - 2 &&
                    t[n][0] === t[t.length - 1][0] &&
                    t[n][1] === t[t.length - 1][1]
                  )
                    continue;
                }
    ...
    (t.lineSlice = function (t, e, n) {
      ...
      for (
        var i,
          ...
          s = on(n, e),
          u = [
            (i = o.properties.index <= s.properties.index ? [o, s] : [s, o])[0].geometry
              .coordinates,
          ],
          c = i[0].properties.index + 1;
        c < i[1].properties.index + 1;
        c++
      )
        u.push(r[c]);
    ...
    (t.greatCircle = function (t, e, n) {
      ...
      return (
        ...
        (i = i || 100),
        (o = o || 10),
        new qs({ x: t[0], y: t[1] }, { x: e[0], y: e[1] }, r).Arc(i, { offset: o }).json()
      );
    }),
    (t.lineSegment = en),
                ...
                for (
                  ...
                  for (var r = 0; r < e.length; r++)
                    if (!e[r].grouped) {
                      ...
                      for (var s = o([e[r].lrCoordinates]), a = r + 1; a < e.length; a++)
                        if (!e[a].grouped) {
                          var u = o([e[a].lrCoordinates]);
                          (function (t, e) {
                            for (var n = me(t), r = 0; r < n.features.length; r++)
                              if (!Pt(n.features[r], e)) return !1;
                            return !0;
                    ...
                    case 'Polygon':
                      return !(function (t, e) {
                        for (var n = 0; n < t.coordinates[0].length; n++)
                          if (Pt(t.coordinates[0][n], e)) return !0;
                        for (var r = 0; r < e.coordinates[0].length; r++)
                          if (Pt(e.coordinates[0][r], t)) return !0;
                        return !1;
                      })(e, t);
                  }
              }
            ...
            case 'Point':
              return (function (t, e) {
                ...
                for (n = 0; n < t.coordinates.length; n++)
                  if (Nr(t.coordinates[n], e.coordinates)) {
                    r = !0;
                    break;
                  }
                return r;
              ...
              return (function (t, e) {
                for (var n = 0; n < e.coordinates.length; n++) {
                  for (var r = !1, i = 0; i < t.coordinates.length; i++)
                    if (Nr(e.coordinates[n], t.coordinates[i])) {
                      r = !0;
                      break;
                    }
                  if (!r) return !1;
          ...
          switch (r) {
            ...
            case 'LineString':
              return (function (t, e) {
                for (var n = !1, r = 0; r < e.coordinates.length; r++)
                  if (
                    (Nn({ type: 'Point', coordinates: e.coordinates[r] }, t, {
                      ignoreEndVertices: !0,
                    }) && (n = !0),
                    !Nn({ type: 'Point', coordinates: e.coordinates[r] }, t, {
                      ignoreEndVertices: !1,
            ...
            case 'MultiPoint':
              return (function (t, e) {
                for (var n = !1, r = 0; r < e.coordinates.length; r++)
                  if (
                    (Nn(e.coordinates[r], t, { ignoreEndVertices: !0 }) && (n = !0),
                    !Nn(e.coordinates[r], t))
                  )
                    return !1;
                return !!n;
              })(i, o);
            ...
            case 'Polygon':
              return (function (t, e) {
                ...
                for (var i = 0; i < e.coordinates[0].length; i++)
                  if (!Pt(e.coordinates[0][i], t)) return !1;
                return !0;
              })(i, o);
            case 'MultiPoint':
              return (function (t, e) {
                for (var n = 0; n < e.coordinates.length; n++)
                  if (!Pt(e.coordinates[n], t, { ignoreBoundary: !0 })) return !1;
                return !0;
              })(i, o);
            default:
              throw new Error('feature2 ' + r + ' geometry not supported');
      ...
      switch (n) {
        ...
        case 'LineString':
          switch (r) {
            ...
            case 'LineString':
              return (function (t, e) {
                if (nn(t, e).features.length > 0)
                  for (var n = 0; n < t.coordinates.length - 1; n++)
                    for (var r = 0; r < e.coordinates.length - 1; r++) {
                      var i = !0;
                      if (
                        ((0 !== r && r !== e.coordinates.length - 2) || (i = !1),
                        Lr(t.coordinates[n], t.coordinates[n + 1], e.coordinates[r], i))
                      )
                        return !0;
                    }
                return !1;
    ...
    (t.clustersDbscan = function (t, e, n) {
      ...
      var r = n.minPoints,
        i = n.units;
      if ((W(t, 'Point', 'Input must contain Points'), null === e || void 0 === e))
      ...
      var o = new Ha.DBSCAN(),
        s = -1;
      return (
        o.run(T(t), E(e, i), r, qt).forEach(function (e) {
          s++,
            e.forEach(function (e) {
              var n = t.features[e];
    ...
    (t.clustersKmeans = function (t, e) {
      ...
      var o = T(t),
        ...
        u = {};
      return (
        a.centroids.forEach(function (t, e) {
          u[e] = t;
        }),
        O(t, function (t, e) {
          var n = a.idxs[e];
    ...
    (t.shortestPath = function (t, n, i) {
      ...
      for (
        var g = f[0],
          ...
          y = f[2],
          _ = f[3],
          m = (o / qt([g, d], [y, d], i)) * (y - g),
          v = (o / qt([g, d], [g, _], i)) * (_ - d),
          x = y - g,
          E = _ - d,
          w = (x - Math.floor(x / m) * m) / 2,
          N = [],
          C = [],
          S = [],
          M = [],
      ...
      var z = new qr(C, { diagonal: !0 }),
        U = z.grid[S.y][S.x],
        Y = z.grid[M.y][M.x],
        V = [h];
      return (
        nu.search(z, U, Y).forEach(function (t) {
    ...
    (t.centerMedian = function (t, e) {
      ...
      return (
        ...
        (o.properties = { tolerance: e.tolerance, medianCandidates: [] }),
    ...
    (t.standardDeviationalEllipse = function (t, e) {
      ...
      O(t, function (t) {
        ...
        (y += Math.pow(n.x * Math.cos(g) - n.y * Math.sin(g), 2) * e),
          (_ += Math.pow(n.x * Math.sin(g) + n.y * Math.cos(g), 2) * e),
          (m += e);
      });
    ...
    (t.dissolve = function (t, e) {
      ...
      for (var u in i) {
        var c = i[u],
          h = !1;
        if (
          (s.search(c).features.forEach(function (t) {
            c = i[u];
            ...
            if (e !== +u) {
              ...
              l &&
                c &&
                ((void 0 !== n && l.properties[n] !== c.properties[n]) ||
                  (Tr(c, l) &&
                    (function (t, e) {
                      var n = a(T(t)),
                        r = a(T(e));
    ...
    (t.pointOnSurface = yn),
    (t.polygonToLineString = kn),
    (t.lineStringToPolygon = jn),
    (t.inside = Pt),
    (t.within = Rt),
    (t.bezier = ue),
    (t.nearest = Fe),
    ...
    (t.radians2degrees = v),
    (t.degrees2radians = x),
    (t.distanceToDegrees = _),
    (t.distanceToRadians = y),
    (t.radiansToDistance = d),
    (t.bearingToAngle = m),
    (t.convertDistance = E),
    (t.toMercator = cn),
    (t.toWgs84 = hn),
    ...
    (t.randomPoint = mi),
    (t.randomPolygon = vi),
    (t.randomLineString = xi),
    (t.getCluster = wi),
    (t.clusterEach = bi),
    (t.clusterReduce = Ii),
    (t.createBins = Ni),
    (t.applyFilter = Ci),
    (t.propertiesContainsFilter = Si),
    (t.filterProperties = Mi),
    (t.earthRadius = Fo),
    (t.factors = qo),
    (t.unitsFactors = Go),
    (t.areaFactors = Bo),
